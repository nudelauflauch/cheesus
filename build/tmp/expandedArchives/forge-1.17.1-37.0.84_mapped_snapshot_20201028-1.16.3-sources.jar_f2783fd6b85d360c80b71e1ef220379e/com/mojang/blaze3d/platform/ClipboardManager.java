...
public class ClipboardManager {
   ...
   private final ByteBuffer f_83986_ = BufferUtils.createByteBuffer(8192);
   ...
   public String m_83995_(long p_83996_, GLFWErrorCallbackI p_83997_) {
      ...
      s = s != null ? StringDecomposer.m_14304_(s) : "";
   ...
   public void m_83988_(long p_83989_, String p_83990_) {
      ...
      if (i < this.f_83986_.capacity()) {
         m_83991_(p_83989_, this.f_83986_, abyte);
      } else {
         ByteBuffer bytebuffer = MemoryUtil.memAlloc(i);

         try {
            m_83991_(p_83989_, bytebuffer, abyte);
         } finally {
