...
public class RealmsServerList extends ValueObject {
   private static final Logger f_87574_ = LogManager.getLogger();
   ...
   public static RealmsServerList m_87577_(String p_87578_) {
      ...
      realmsserverlist.f_87573_ = Lists.newArrayList();
      ...
      try {
         ...
         if (jsonobject.get("servers").isJsonArray()) {
            ...
            while(iterator.hasNext()) {
               realmsserverlist.f_87573_.add(RealmsServer.m_87499_(iterator.next().getAsJsonObject()));
            }
         }
      } catch (Exception exception) {
         f_87574_.error("Could not parse McoServerList: {}", (Object)exception.getMessage());
      }
