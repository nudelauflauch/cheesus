...
public abstract class SimpleCriterionTrigger<T extends AbstractCriterionTriggerInstance> implements CriterionTrigger<T> {
   ...
   public final T m_5868_(JsonObject p_66246_, DeserializationContext p_66247_) {
      EntityPredicate.Composite entitypredicate$composite = EntityPredicate.Composite.m_36677_(p_66246_, "player", p_66247_);
      return this.m_7214_(p_66246_, entitypredicate$composite, p_66247_);
   }
      ...
      if (set != null && !set.isEmpty()) {
         ...
         if (list != null) {
            for(CriterionTrigger.Listener<T> listener1 : list) {
               listener1.m_13686_(playeradvancements);
            }
         }
