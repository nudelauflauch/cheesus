...
public class LogaritmicProgressOption extends ProgressOption {
   ...
   public double m_6917_(double p_90974_) {
      return Math.log(p_90974_ / this.f_92205_) / Math.log(this.f_92206_ / this.f_92205_);
   }

   public double m_6912_(double p_90976_) {
      return this.f_92205_ * Math.pow(Math.E, Math.log(this.f_92206_ / this.f_92205_) * p_90976_);
   }
}