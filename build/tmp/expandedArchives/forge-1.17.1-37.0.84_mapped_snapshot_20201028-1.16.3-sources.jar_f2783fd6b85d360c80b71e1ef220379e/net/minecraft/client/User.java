...
public class User {
   ...
   public User(String p_92540_, String p_92541_, String p_92542_, String p_92543_) {
      ...
      this.f_92538_ = User.Type.m_92561_(p_92543_);
   }
   ...
   public static enum Type {
      ...
      private static final Map<String, User.Type> f_92551_ = Arrays.stream(values()).collect(Collectors.toMap((p_92560_) -> {
         return p_92560_.f_92552_;
      }, Function.identity()));
      ...
      @Nullable
      public static User.Type m_92561_(String p_92562_) {
