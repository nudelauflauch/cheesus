...
public class SmokerScreen extends AbstractFurnaceScreen<SmokerMenu> {
   private static final ResourceLocation f_99297_ = new ResourceLocation("textures/gui/container/smoker.png");

   public SmokerScreen(SmokerMenu p_99300_, Inventory p_99301_, Component p_99302_) {
      super(p_99300_, new SmokingRecipeBookComponent(), p_99301_, p_99302_, f_99297_);
   }
}