...
public class HorseMarkingLayer extends RenderLayer<Horse, HorseModel<Horse>> {
   ...
   public void m_6494_(PoseStack p_117058_, MultiBufferSource p_117059_, int p_117060_, Horse p_117061_, float p_117062_, float p_117063_, float p_117064_, float p_117065_, float p_117066_, float p_117067_) {
      ResourceLocation resourcelocation = f_117042_.get(p_117061_.m_30724_());
      if (resourcelocation != null && !p_117061_.m_20145_()) {
         VertexConsumer vertexconsumer = p_117059_.m_6299_(RenderType.m_110473_(resourcelocation));
         this.m_117386_().m_7695_(p_117058_, vertexconsumer, p_117060_, LivingEntityRenderer.m_115338_(p_117061_, 0.0F), 1.0F, 1.0F, 1.0F, 1.0F);
      }
   }
}