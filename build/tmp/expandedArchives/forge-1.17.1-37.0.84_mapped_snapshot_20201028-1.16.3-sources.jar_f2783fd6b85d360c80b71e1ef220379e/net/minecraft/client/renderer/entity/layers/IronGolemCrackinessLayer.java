...
public class IronGolemCrackinessLayer extends RenderLayer<IronGolem, IronGolemModel<IronGolem>> {
   ...
   public void m_6494_(PoseStack p_117148_, MultiBufferSource p_117149_, int p_117150_, IronGolem p_117151_, float p_117152_, float p_117153_, float p_117154_, float p_117155_, float p_117156_, float p_117157_) {
      if (!p_117151_.m_20145_()) {
         IronGolem.Crackiness irongolem$crackiness = p_117151_.m_28873_();
         if (irongolem$crackiness != IronGolem.Crackiness.NONE) {
            ResourceLocation resourcelocation = f_117132_.get(irongolem$crackiness);
            m_117376_(this.m_117386_(), resourcelocation, p_117148_, p_117149_, p_117150_, p_117151_, 1.0F, 1.0F, 1.0F);
         }
      }
   }
}