...
public class PandaHoldsItemLayer extends RenderLayer<Panda, PandaModel<Panda>> {
   ...
   public void m_6494_(PoseStack p_117280_, MultiBufferSource p_117281_, int p_117282_, Panda p_117283_, float p_117284_, float p_117285_, float p_117286_, float p_117287_, float p_117288_, float p_117289_) {
      ItemStack itemstack = p_117283_.m_6844_(EquipmentSlot.MAINHAND);
      if (p_117283_.m_29150_() && !p_117283_.m_29165_()) {
         float f = -0.6F;
         float f1 = 1.4F;
         if (p_117283_.m_29152_()) {
            f -= 0.2F * Mth.m_14031_(p_117287_ * 0.6F) + 0.2F;
            f1 -= 0.09F * Mth.m_14031_(p_117287_ * 0.6F);
         }

         p_117280_.m_85836_();
         p_117280_.m_85837_((double)0.1F, (double)f1, (double)f);
         Minecraft.m_91087_().m_91292_().m_109322_(p_117283_, itemstack, ItemTransforms.TransformType.GROUND, false, p_117280_, p_117281_, p_117282_);
         p_117280_.m_85849_();
      }
   }
}