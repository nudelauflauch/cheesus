...
public class DirectAssetIndex extends AssetIndex {
   ...
   public Collection<ResourceLocation> m_6487_(String p_118639_, String p_118640_, int p_118641_, Predicate<String> p_118642_) {
      Path path = this.f_118633_.toPath().resolve(p_118640_);
      ...
      try {
         ...
         f_118524_.warn("Unable to getFiles on {}", p_118639_, ioexception);
      }
