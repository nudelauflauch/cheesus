...
public class LegacyPackResourcesAdapter implements PackResources {
   private final PackResources f_118691_;
   private final Map<ResourceLocation, ResourceLocation> f_118692_;
   public static final Map<ResourceLocation, ResourceLocation> f_118690_ = Util.m_137537_(() -> {
      ...
      BiConsumer<String, String> biconsumer = (p_174834_, p_174835_) -> {
         ...
         builder.put(m_118715_(resourcelocation), m_118715_(resourcelocation1));
      };
   ...
   private static ResourceLocation m_118715_(ResourceLocation p_118716_) {
      return new ResourceLocation(p_118716_.m_135827_(), p_118716_.m_135815_() + ".mcmeta");
   }

   public LegacyPackResourcesAdapter(PackResources p_118695_, Map<ResourceLocation, ResourceLocation> p_118696_) {
      this.f_118691_ = p_118695_;
      this.f_118692_ = p_118696_;
   }

   private ResourceLocation m_118723_(ResourceLocation p_118724_) {
      return this.f_118692_.getOrDefault(p_118724_, p_118724_);
   }

   public InputStream m_5542_(String p_118722_) throws IOException {
      return this.f_118691_.m_5542_(p_118722_);
   }

   public InputStream m_8031_(PackType p_118707_, ResourceLocation p_118708_) throws IOException {
      return this.f_118691_.m_8031_(p_118707_, this.m_118723_(p_118708_));
   }

   public Collection<ResourceLocation> m_7466_(PackType p_118701_, String p_118702_, String p_118703_, int p_118704_, Predicate<String> p_118705_) {
      return Collections.emptyList();
   }

   public boolean m_7211_(PackType p_118719_, ResourceLocation p_118720_) {
      return this.f_118691_.m_7211_(p_118719_, this.m_118723_(p_118720_));
   }

   public Set<String> m_5698_(PackType p_118699_) {
      return this.f_118691_.m_5698_(p_118699_);
   }

   @Nullable
   public <T> T m_5550_(MetadataSectionSerializer<T> p_118710_) throws IOException {
      return this.f_118691_.m_5550_(p_118710_);
   }

   public String m_8017_() {
      return this.f_118691_.m_8017_();
   }

   public void close() {
      this.f_118691_.close();
   }
}