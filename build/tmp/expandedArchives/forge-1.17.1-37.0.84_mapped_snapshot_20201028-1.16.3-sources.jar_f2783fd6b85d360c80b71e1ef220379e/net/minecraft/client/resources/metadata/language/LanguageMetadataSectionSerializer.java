...
public class LanguageMetadataSectionSerializer implements MetadataSectionSerializer<LanguageMetadataSection> {
   ...
   public LanguageMetadataSection m_6322_(JsonObject p_119107_) {
      ...
      for(Entry<String, JsonElement> entry : p_119107_.entrySet()) {
         ...
         JsonObject jsonobject = GsonHelper.m_13918_(entry.getValue(), "language");
         String s1 = GsonHelper.m_13906_(jsonobject, "region");
         String s2 = GsonHelper.m_13906_(jsonobject, "name");
         boolean flag = GsonHelper.m_13855_(jsonobject, "bidirectional", false);
         if (s1.isEmpty()) {
