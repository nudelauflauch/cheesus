...
public class SimpleSoundInstance extends AbstractSoundInstance {
   public SimpleSoundInstance(SoundEvent p_119717_, SoundSource p_119718_, float p_119719_, float p_119720_, BlockPos p_119721_) {
      this(p_119717_, p_119718_, p_119719_, p_119720_, (double)p_119721_.m_123341_() + 0.5D, (double)p_119721_.m_123342_() + 0.5D, (double)p_119721_.m_123343_() + 0.5D);
   }

   public static SimpleSoundInstance m_119752_(SoundEvent p_119753_, float p_119754_) {
      return m_119755_(p_119753_, p_119754_, 0.25F);
   }

   public static SimpleSoundInstance m_119755_(SoundEvent p_119756_, float p_119757_, float p_119758_) {
      return new SimpleSoundInstance(p_119756_.m_11660_(), SoundSource.MASTER, p_119758_, p_119757_, false, 0, SoundInstance.Attenuation.NONE, 0.0D, 0.0D, 0.0D, true);
   }

   public static SimpleSoundInstance m_119745_(SoundEvent p_119746_) {
      return new SimpleSoundInstance(p_119746_.m_11660_(), SoundSource.MUSIC, 1.0F, 1.0F, false, 0, SoundInstance.Attenuation.NONE, 0.0D, 0.0D, 0.0D, true);
   }
   ...
   public static SimpleSoundInstance m_119766_(SoundEvent p_119767_, float p_119768_, float p_119769_) {
      return new SimpleSoundInstance(p_119767_.m_11660_(), SoundSource.AMBIENT, p_119769_, p_119768_, false, 0, SoundInstance.Attenuation.NONE, 0.0D, 0.0D, 0.0D, true);
   }

   public static SimpleSoundInstance m_119759_(SoundEvent p_119760_) {
      return m_119766_(p_119760_, 1.0F, 1.0F);
   }

   public static SimpleSoundInstance m_119761_(SoundEvent p_119762_, double p_119763_, double p_119764_, double p_119765_) {
   ...
   private SimpleSoundInstance(SoundEvent p_119723_, SoundSource p_119724_, float p_119725_, float p_119726_, boolean p_119727_, int p_119728_, SoundInstance.Attenuation p_119729_, double p_119730_, double p_119731_, double p_119732_) {
      this(p_119723_.m_11660_(), p_119724_, p_119725_, p_119726_, p_119727_, p_119728_, p_119729_, p_119730_, p_119731_, p_119732_, false);
   }
   ...
   public SimpleSoundInstance(ResourceLocation p_119734_, SoundSource p_119735_, float p_119736_, float p_119737_, boolean p_119738_, int p_119739_, SoundInstance.Attenuation p_119740_, double p_119741_, double p_119742_, double p_119743_, boolean p_119744_) {
      ...
      this.f_119573_ = p_119736_;
      this.f_119574_ = p_119737_;
      this.f_119575_ = p_119741_;
      this.f_119576_ = p_119742_;
      this.f_119577_ = p_119743_;
      this.f_119578_ = p_119738_;
      this.f_119579_ = p_119739_;
      this.f_119580_ = p_119740_;
      this.f_119582_ = p_119744_;
   }
}