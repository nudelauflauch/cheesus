...
public class OperationArgument implements ArgumentType<OperationArgument.Operation> {
   ...
   private static final SimpleCommandExceptionType f_103265_ = new SimpleCommandExceptionType(new TranslatableComponent("arguments.operation.invalid"));
   private static final SimpleCommandExceptionType f_103266_ = new SimpleCommandExceptionType(new TranslatableComponent("arguments.operation.div0"));

   public static OperationArgument m_103269_() {
      return new OperationArgument();
   }

   public static OperationArgument.Operation m_103275_(CommandContext<CommandSourceStack> p_103276_, String p_103277_) {
   ...
   public OperationArgument.Operation parse(StringReader p_103274_) throws CommandSyntaxException {
      if (!p_103274_.canRead()) {
         ...
         return m_103281_(p_103274_.getString().substring(i, p_103274_.getCursor()));
      }
   }
   ...
   private static OperationArgument.Operation m_103281_(String p_103282_) throws CommandSyntaxException {
      return (p_103282_.equals("><") ? (p_103279_, p_103280_) -> {
         int i = p_103279_.m_83400_();
         p_103279_.m_83402_(p_103280_.m_83400_());
         p_103280_.m_83402_(i);
      } : m_103286_(p_103282_));
   }

   private static OperationArgument.SimpleOperation m_103286_(String p_103287_) throws CommandSyntaxException {
      switch(p_103287_) {
      case "=":
   ...
   public interface Operation {
      void m_6407_(Score p_103306_, Score p_103307_) throws CommandSyntaxException;
   }

   @FunctionalInterface
   interface SimpleOperation extends OperationArgument.Operation {
      int m_103308_(int p_103309_, int p_103310_) throws CommandSyntaxException;

      default void m_6407_(Score p_103312_, Score p_103313_) throws CommandSyntaxException {
