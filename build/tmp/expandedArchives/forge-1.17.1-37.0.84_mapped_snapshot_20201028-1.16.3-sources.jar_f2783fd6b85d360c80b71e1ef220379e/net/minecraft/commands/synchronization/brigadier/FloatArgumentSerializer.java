...
public class FloatArgumentSerializer implements ArgumentSerializer<FloatArgumentType> {
   public void m_6017_(FloatArgumentType p_121721_, FriendlyByteBuf p_121722_) {
      boolean flag = p_121721_.getMinimum() != -Float.MAX_VALUE;
      boolean flag1 = p_121721_.getMaximum() != Float.MAX_VALUE;
      p_121722_.writeByte(BrigadierArgumentSerializers.m_121688_(flag, flag1));
      if (flag) {
   ...
   public FloatArgumentType m_7813_(FriendlyByteBuf p_121724_) {
      byte b0 = p_121724_.readByte();
      float f = BrigadierArgumentSerializers.m_121686_(b0) ? p_121724_.readFloat() : -Float.MAX_VALUE;
      float f1 = BrigadierArgumentSerializers.m_121691_(b0) ? p_121724_.readFloat() : Float.MAX_VALUE;
      return FloatArgumentType.floatArg(f, f1);
   }

   public void m_6964_(FloatArgumentType p_121718_, JsonObject p_121719_) {
