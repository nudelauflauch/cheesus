...
public class LongArgumentSerializer implements ArgumentSerializer<LongArgumentType> {
   public void m_6017_(LongArgumentType p_121755_, FriendlyByteBuf p_121756_) {
      boolean flag = p_121755_.getMinimum() != Long.MIN_VALUE;
      boolean flag1 = p_121755_.getMaximum() != Long.MAX_VALUE;
      p_121756_.writeByte(BrigadierArgumentSerializers.m_121688_(flag, flag1));
      if (flag) {
   ...
   public LongArgumentType m_7813_(FriendlyByteBuf p_121758_) {
      byte b0 = p_121758_.readByte();
      long i = BrigadierArgumentSerializers.m_121686_(b0) ? p_121758_.readLong() : Long.MIN_VALUE;
      long j = BrigadierArgumentSerializers.m_121691_(b0) ? p_121758_.readLong() : Long.MAX_VALUE;
      return LongArgumentType.longArg(i, j);
   }

   public void m_6964_(LongArgumentType p_121752_, JsonObject p_121753_) {
