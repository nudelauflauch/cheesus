...
public class NbtOps implements DynamicOps<Tag> {
   ...
   public <U> U convertTo(DynamicOps<U> p_128980_, Tag p_128981_) {
      ...
      case 1:
         return p_128980_.createByte(((NumericTag)p_128981_).m_7063_());
      case 2:
         return p_128980_.createShort(((NumericTag)p_128981_).m_7053_());
      case 3:
         return p_128980_.createInt(((NumericTag)p_128981_).m_7047_());
      case 4:
         return p_128980_.createLong(((NumericTag)p_128981_).m_7046_());
      case 5:
         return p_128980_.createFloat(((NumericTag)p_128981_).m_7057_());
      case 6:
         return p_128980_.createDouble(((NumericTag)p_128981_).m_7061_());
      case 7:
         return p_128980_.createByteList(ByteBuffer.wrap(((ByteArrayTag)p_128981_).m_128227_()));
      case 8:
         return p_128980_.createString(p_128981_.m_7916_());
      case 9:
         return this.convertList(p_128980_, p_128981_);
      case 10:
         return this.convertMap(p_128980_, p_128981_);
      case 11:
         return p_128980_.createIntList(Arrays.stream(((IntArrayTag)p_128981_).m_128648_()));
      case 12:
         return p_128980_.createLongList(Arrays.stream(((LongArrayTag)p_128981_).m_128851_()));
      default:
   ...
   public DataResult<Number> getNumberValue(Tag p_129030_) {
      return p_129030_ instanceof NumericTag ? DataResult.success(((NumericTag)p_129030_).m_8103_()) : DataResult.error("Not a number");
   }
   ...
   public DataResult<String> getStringValue(Tag p_129061_) {
      return p_129061_ instanceof StringTag ? DataResult.success(p_129061_.m_7916_()) : DataResult.error("Not a string");
   }
   ...
   private static CollectionTag<?> m_128964_(byte p_128965_, byte p_128966_) {
      if (m_128967_(p_128965_, p_128966_, (byte)4)) {
         return new LongArrayTag(new long[0]);
      } else if (m_128967_(p_128965_, p_128966_, (byte)1)) {
         return new ByteArrayTag(new byte[0]);
      } else {
         return (CollectionTag<?>)(m_128967_(p_128965_, p_128966_, (byte)3) ? new IntArrayTag(new int[0]) : new ListTag());
      }
   }
   ...
   public DataResult<Tag> mergeToList(Tag p_129041_, Tag p_129042_) {
      if (!(p_129041_ instanceof CollectionTag) && !(p_129041_ instanceof EndTag)) {
         ...
         CollectionTag<?> collectiontag = m_128964_(p_129041_ instanceof CollectionTag ? ((CollectionTag)p_129041_).m_7264_() : 0, p_129042_.m_7060_());
         m_129012_(collectiontag, p_129041_, p_129042_);
   ...
   public DataResult<Tag> mergeToList(Tag p_129038_, List<Tag> p_129039_) {
      if (!(p_129038_ instanceof CollectionTag) && !(p_129038_ instanceof EndTag)) {
         ...
         CollectionTag<?> collectiontag = m_128964_(p_129038_ instanceof CollectionTag ? ((CollectionTag)p_129038_).m_7264_() : 0, p_129039_.stream().findFirst().map(Tag::m_7060_).orElse((byte)0));
         m_129008_(collectiontag, p_129038_, p_129039_);
         return DataResult.success(collectiontag);
      }
   }
   ...
   public DataResult<Tag> mergeToMap(Tag p_129044_, Tag p_129045_, Tag p_129046_) {
      if (!(p_129044_ instanceof CompoundTag) && !(p_129044_ instanceof EndTag)) {
         ...
         if (p_129044_ instanceof CompoundTag) {
            ...
            compoundtag1.m_128431_().forEach((p_129068_) -> {
               compoundtag.m_128365_(p_129068_, compoundtag1.m_128423_(p_129068_));
            });
         }
   ...
   public DataResult<Tag> mergeToMap(Tag p_129032_, MapLike<Tag> p_129033_) {
      if (!(p_129032_ instanceof CompoundTag) && !(p_129032_ instanceof EndTag)) {
         ...
         if (p_129032_ instanceof CompoundTag) {
            ...
            compoundtag1.m_128431_().forEach((p_129059_) -> {
               compoundtag.m_128365_(p_129059_, compoundtag1.m_128423_(p_129059_));
            });
         }
         ...
         p_129033_.entries().forEach((p_128994_) -> {
            ...
            if (!(tag instanceof StringTag)) {
               ...
               compoundtag.m_128365_(tag.m_7916_(), p_128994_.getSecond());
            }
         });
   ...
   public DataResult<Stream<Pair<Tag, Tag>>> getMapValues(Tag p_129070_) {
      if (!(p_129070_ instanceof CompoundTag)) {
         ...
         return DataResult.success(compoundtag.m_128431_().stream().map((p_129021_) -> {
            return Pair.of(this.createString(p_129021_), compoundtag.m_128423_(p_129021_));
         }));
      }
   }
   ...
   public DataResult<Consumer<BiConsumer<Tag, Tag>>> getMapEntries(Tag p_129103_) {
      if (!(p_129103_ instanceof CompoundTag)) {
         ...
         return DataResult.success((p_129024_) -> {
            compoundtag.m_128431_().forEach((p_178006_) -> {
               p_129024_.accept(this.createString(p_178006_), compoundtag.m_128423_(p_178006_));
            });
         });
      }
   }
      ...
      if (!(p_129105_ instanceof CompoundTag)) {
         ...
         return DataResult.success(new MapLike<Tag>() {
            ...
            public Stream<Pair<Tag, Tag>> entries() {
               return compoundtag.m_128431_().stream().map((p_129172_) -> {
                  return Pair.of(NbtOps.this.createString(p_129172_), compoundtag.m_128423_(p_129172_));
               });
            }
   ...
   public Tag createMap(Stream<Pair<Tag, Tag>> p_129004_) {
      ...
      p_129004_.forEach((p_129018_) -> {
         compoundtag.m_128365_(p_129018_.getFirst().m_7916_(), p_129018_.getSecond());
      });
      return compoundtag;
   }
   ...
   public DataResult<ByteBuffer> getByteBuffer(Tag p_129132_) {
      return p_129132_ instanceof ByteArrayTag ? DataResult.success(ByteBuffer.wrap(((ByteArrayTag)p_129132_).m_128227_())) : DynamicOps.super.getByteBuffer(p_129132_);
   }
   ...
   public DataResult<IntStream> getIntStream(Tag p_129134_) {
      return p_129134_ instanceof IntArrayTag ? DataResult.success(Arrays.stream(((IntArrayTag)p_129134_).m_128648_())) : DynamicOps.super.getIntStream(p_129134_);
   }
   ...
   public DataResult<LongStream> getLongStream(Tag p_129136_) {
      return p_129136_ instanceof LongArrayTag ? DataResult.success(Arrays.stream(((LongArrayTag)p_129136_).m_128851_())) : DynamicOps.super.getLongStream(p_129136_);
   }
   ...
   public Tag remove(Tag p_129035_, String p_129036_) {
      if (p_129035_ instanceof CompoundTag) {
         ...
         compoundtag.m_128431_().stream().filter((p_128988_) -> {
            return !Objects.equals(p_128988_, p_129036_);
         }).forEach((p_129028_) -> {
            compoundtag1.m_128365_(p_129028_, compoundtag.m_128423_(p_129028_));
         });
         return compoundtag1;
      } else {
         return p_129035_;
      ...
      protected DataResult<Tag> build(CompoundTag p_129190_, Tag p_129191_) {
         if (p_129191_ != null && p_129191_ != EndTag.f_128534_) {
            if (!(p_129191_ instanceof CompoundTag)) {
               ...
               for(Entry<String, Tag> entry : p_129190_.m_128450_().entrySet()) {
