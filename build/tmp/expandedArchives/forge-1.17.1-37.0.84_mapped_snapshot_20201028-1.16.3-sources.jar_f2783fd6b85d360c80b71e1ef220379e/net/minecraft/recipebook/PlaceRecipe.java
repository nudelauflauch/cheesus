...
public interface PlaceRecipe<T> {
   default void m_135408_(int p_135409_, int p_135410_, int p_135411_, Recipe<?> p_135412_, Iterator<T> p_135413_, int p_135414_) {
      ...
      for(int k = 0; k < p_135410_; ++k) {
         ...
         int l = Mth.m_14143_((float)p_135410_ / 2.0F - (float)j / 2.0F);
         if (flag && l > k) {
            k1 += p_135409_;
            ++k;
         }
         ...
         for(int i1 = 0; i1 < p_135409_; ++i1) {
            ...
            l = Mth.m_14143_((float)p_135409_ / 2.0F - (float)i / 2.0F);
            int j1 = i;
            boolean flag1 = i1 < i;
            if (flag) {
               j1 = l + i;
            ...
            if (flag1) {
               this.m_5817_(p_135413_, k1, p_135414_, k, i1);
            } else if (j1 == i1) {
               k1 += p_135409_ - i1;
               break;
            }
   ...
   void m_5817_(Iterator<T> p_135415_, int p_135416_, int p_135417_, int p_135418_, int p_135419_);
}
