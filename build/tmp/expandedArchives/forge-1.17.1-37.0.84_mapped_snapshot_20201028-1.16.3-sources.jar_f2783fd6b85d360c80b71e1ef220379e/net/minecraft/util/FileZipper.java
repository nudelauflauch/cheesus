...
public class FileZipper implements Closeable {
   private static final Logger f_144691_ = LogManager.getLogger();
   ...
   public FileZipper(Path p_144697_) {
      ...
      try {
         this.f_144694_ = Util.f_143778_.newFileSystem(this.f_144693_, ImmutableMap.of("create", "true"));
   ...
   public void m_144703_(Path p_144704_, String p_144705_) {
      try {
         Path path = this.f_144694_.getPath(File.separator);
   ...
   public void close() {
      try {
         ...
         Files.move(this.f_144693_, this.f_144692_);
