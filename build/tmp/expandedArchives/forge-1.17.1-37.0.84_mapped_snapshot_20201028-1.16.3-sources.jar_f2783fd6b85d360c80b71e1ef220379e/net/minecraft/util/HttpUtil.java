...
public class HttpUtil {
   private static final Logger f_13937_ = LogManager.getLogger();
   ...
   public static String m_144816_(Map<String, Object> p_144817_) {
   ...
   public static String m_144811_(URL p_144812_, Map<String, Object> p_144813_, boolean p_144814_, @Nullable Proxy p_144815_) {
      return m_144806_(p_144812_, m_144816_(p_144813_), p_144814_, p_144815_);
   }

   private static String m_144806_(URL p_144807_, String p_144808_, boolean p_144809_, @Nullable Proxy p_144810_) {
      try {
         if (p_144810_ == null) {
         ...
         if (!p_144809_) {
            f_13937_.error("Could not post to {}", p_144807_, exception);
         }
   ...
   public static CompletableFuture<?> m_13947_(File p_13948_, String p_13949_, Map<String, String> p_13950_, int p_13951_, @Nullable ProgressListener p_13952_, Proxy p_13953_) {
      return CompletableFuture.supplyAsync(() -> {
         HttpURLConnection httpurlconnection = null;
         InputStream inputstream = null;
         OutputStream outputstream = null;
         if (p_13952_ != null) {
            p_13952_.m_6308_(new TranslatableComponent("resourcepack.downloading"));
            p_13952_.m_6307_(new TranslatableComponent("resourcepack.requesting"));
         }
         ...
         try {
            try {
               ...
               for(Entry<String, String> entry : p_13950_.entrySet()) {
                  ...
                  if (p_13952_ != null) {
                     p_13952_.m_6952_((int)(++f / f1 * 100.0F));
                  }
               }
               ...
               if (p_13952_ != null) {
                  p_13952_.m_6307_(new TranslatableComponent("resourcepack.progress", String.format(Locale.ROOT, "%.2f", f1 / 1000.0F / 1000.0F)));
               }
               ...
               if (p_13948_.exists()) {
                  ...
                  f_13937_.warn("Deleting {} as it does not match what we currently have ({} vs our {}).", p_13948_, i, j);
               ...
               if (httpurlconnection != null) {
                  ...
                  try {
                     f_13937_.error(IOUtils.toString(inputstream1));
