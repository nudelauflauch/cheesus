...
public class Mth {
   ...
   public static final float f_144831_ = ((float)Math.PI / 2F);
   public static final float f_144832_ = ((float)Math.PI * 2F);
   public static final float f_144833_ = ((float)Math.PI / 180F);
   public static final float f_144834_ = (180F / (float)Math.PI);
   ...
   private static final Random f_13996_ = new Random();
   ...
   public static double m_14085_(double p_14086_, double p_14087_, double p_14088_) {
      if (p_14088_ < 0.0D) {
         ...
         return p_14088_ > 1.0D ? p_14087_ : m_14139_(p_14088_, p_14086_, p_14087_);
      }
   }
   ...
   public static float m_144920_(float p_144921_, float p_144922_, float p_144923_) {
      if (p_144923_ < 0.0F) {
         ...
         return p_144923_ > 1.0F ? p_144922_ : m_14179_(p_144923_, p_144921_, p_144922_);
      }
   }
   ...
   public static int m_14072_(Random p_14073_, int p_14074_, int p_14075_) {
      return p_14074_ >= p_14075_ ? p_14074_ : p_14073_.nextInt(p_14075_ - p_14074_ + 1) + p_14074_;
   }

   public static float m_14068_(Random p_14069_, float p_14070_, float p_14071_) {
      return p_14070_ >= p_14071_ ? p_14070_ : p_14069_.nextFloat() * (p_14071_ - p_14070_) + p_14070_;
   }

   public static double m_14064_(Random p_14065_, double p_14066_, double p_14067_) {
   ...
   public static float m_14118_(float p_14119_, float p_14120_) {
      return m_14177_(p_14120_ - p_14119_);
   }

   public static float m_14145_(float p_14146_, float p_14147_) {
      return m_14154_(m_14118_(p_14146_, p_14147_));
   }

   public static float m_14094_(float p_14095_, float p_14096_, float p_14097_) {
      float f = m_14118_(p_14095_, p_14096_);
      float f1 = m_14036_(f, -p_14097_, p_14097_);
      return p_14096_ - f1;
   }

   public static float m_14121_(float p_14122_, float p_14123_, float p_14124_) {
      p_14124_ = m_14154_(p_14124_);
      return p_14122_ < p_14123_ ? m_14036_(p_14122_ + p_14124_, p_14122_, p_14123_) : m_14036_(p_14122_ - p_14124_, p_14123_, p_14122_);
   }

   public static float m_14148_(float p_14149_, float p_14150_, float p_14151_) {
      float f = m_14118_(p_14149_, p_14150_);
      return m_14121_(p_14149_, p_14149_ + f, p_14151_);
   }
   ...
   public static int m_144905_(String p_144906_, int p_144907_, int p_144908_) {
      return Math.max(p_144908_, m_14059_(p_144906_, p_144907_));
   }
   ...
   public static double m_144901_(String p_144902_, double p_144903_, double p_144904_) {
      return Math.max(p_144904_, m_144898_(p_144902_, p_144903_));
   }
   ...
   public static int m_14159_(float p_14160_, float p_14161_, float p_14162_) {
      return m_14103_(m_14143_(p_14160_ * 255.0F), m_14143_(p_14161_ * 255.0F), m_14143_(p_14162_ * 255.0F));
   }
   ...
   public static float m_14187_(float p_14188_) {
      return p_14188_ - (float)m_14143_(p_14188_);
   }
   ...
   public static UUID m_14062_(Random p_14063_) {
   ...
   public static int m_14169_(float p_14170_, float p_14171_, float p_14172_) {
      ...
      int j = m_14045_((int)(f4 * 255.0F), 0, 255);
      int k = m_14045_((int)(f5 * 255.0F), 0, 255);
      int l = m_14045_((int)(f6 * 255.0F), 0, 255);
      return j << 16 | k << 8 | l;
   }
   ...
   public static double m_14019_(double p_14020_, double p_14021_, double p_14022_, double p_14023_, double p_14024_, double p_14025_, double p_14026_, double p_14027_, double p_14028_, double p_14029_, double p_14030_) {
      return m_14139_(p_14022_, m_14012_(p_14020_, p_14021_, p_14023_, p_14024_, p_14025_, p_14026_), m_14012_(p_14020_, p_14021_, p_14027_, p_14028_, p_14029_, p_14030_));
   }
   ...
   public static double m_144954_(double p_144955_) {
      return p_144955_ + (2.0D * (new Random((long)m_14107_(p_144955_ * 3000.0D))).nextDouble() - 1.0D) * 1.0E-7D / 2.0D;
   }
   ...
   public static int m_144928_(Random p_144929_, int p_144930_, int p_144931_) {
      return p_144929_.nextInt(p_144931_ - p_144930_ + 1) + p_144930_;
   }

   public static float m_144924_(Random p_144925_, float p_144926_, float p_144927_) {
      return p_144925_.nextFloat() * (p_144927_ - p_144926_) + p_144926_;
   }

   public static float m_144935_(Random p_144936_, float p_144937_, float p_144938_) {
      return p_144937_ + (float)p_144936_.nextGaussian() * p_144938_;
   }

   public static double m_144877_(int p_144878_, double p_144879_, int p_144880_) {
