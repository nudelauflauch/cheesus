...
public class DataFixers {
   ...
   private static final DataFixer f_14510_ = m_14529_();

   private static DataFixer m_14529_() {
      DataFixerBuilder datafixerbuilder = new DataFixerBuilder(SharedConstants.m_136187_().getWorldVersion());
      m_14513_(datafixerbuilder);
      return datafixerbuilder.build(Util.m_137577_());
   }
   ...
   private static void m_14513_(DataFixerBuilder p_14514_) {
      ...
      p_14514_.addFixer(new AddNewChoices(schema16, "Add 1.10 entities fix", References.f_16786_));
      Schema schema17 = p_14514_.addSchema(502, f_14508_);
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema17, "cooked_fished item renamer", (p_14533_) -> {
         return Objects.equals(NamespacedSchema.m_17311_(p_14533_), "minecraft:cooked_fished") ? "minecraft:cooked_fish" : p_14533_;
      }));
      ...
      p_14514_.addFixer(new AddNewChoices(schema27, "added shulker box", References.f_16781_));
      ...
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema31, "totem item renamer", m_14517_("minecraft:totem", "minecraft:totem_of_undying")));
      Schema schema32 = p_14514_.addSchema(1022, V1022::new);
      p_14514_.addFixer(new WriteAndReadFix(schema32, "added shoulder entities to players", References.f_16772_));
      ...
      p_14514_.addFixer(new AddNewChoices(schema37, "AddTrappedChestFix", References.f_16781_));
      ...
      p_14514_.addFixer(new AddNewChoices(schema42, "RemoveNoteBlockFlowerPotFix", References.f_16781_));
      ...
      p_14514_.addFixer(new WriteAndReadFix(schema43, "Rewrite objectives", References.f_16791_));
      ...
      p_14514_.addFixer(new AddNewChoices(schema50, "Add 1.13 entities fix", References.f_16786_));
      Schema schema51 = p_14514_.addSchema(1474, f_14509_);
      p_14514_.addFixer(new ColorlessShulkerEntityFix(schema51, false));
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema51, "Colorless shulker block fixer", (p_14531_) -> {
         return Objects.equals(NamespacedSchema.m_17311_(p_14531_), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : p_14531_;
      }));
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema51, "Colorless shulker item fixer", (p_14516_) -> {
         return Objects.equals(NamespacedSchema.m_17311_(p_14516_), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : p_14516_;
      }));
      Schema schema52 = p_14514_.addSchema(1475, f_14509_);
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema52, "Flowing fixer", m_14524_(ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava"))));
      Schema schema53 = p_14514_.addSchema(1480, f_14509_);
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema53, "Rename coral blocks", m_14524_(RenamedCoralFix.f_16850_)));
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema53, "Rename coral items", m_14524_(RenamedCoralFix.f_16850_)));
      Schema schema54 = p_14514_.addSchema(1481, V1481::new);
      p_14514_.addFixer(new AddNewChoices(schema54, "Add conduit", References.f_16781_));
      Schema schema55 = p_14514_.addSchema(1483, V1483::new);
      p_14514_.addFixer(new EntityPufferfishRenameFix(schema55, true));
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema55, "Rename pufferfish egg item", m_14524_(EntityPufferfishRenameFix.f_15584_)));
      Schema schema56 = p_14514_.addSchema(1484, f_14509_);
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema56, "Rename seagrass items", m_14524_(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema56, "Rename seagrass blocks", m_14524_(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
      ...
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema57, "Rename cod/salmon egg items", m_14524_(EntityCodSalmonFix.f_15390_)));
      Schema schema58 = p_14514_.addSchema(1487, f_14509_);
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema58, "Rename prismarine_brick(s)_* blocks", m_14524_(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema58, "Rename prismarine_brick(s)_* items", m_14524_(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
      ...
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema60, "Rename melon_block", m_14517_("minecraft:melon_block", "minecraft:melon")));
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema60, "Rename melon_block/melon/speckled_melon", m_14524_(ImmutableMap.of("minecraft:melon_block", "minecraft:melon", "minecraft:melon", "minecraft:melon_slice", "minecraft:speckled_melon", "minecraft:glistering_melon_slice"))));
      ...
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema68, "Block renamening fix", m_14524_(EntityTheRenameningFix.f_15702_)));
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema68, "Item renamening fix", m_14524_(EntityTheRenameningFix.f_15703_)));
      ...
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema70, "Rename coral fan blocks", m_14524_(RenamedCoralFansFix.f_16848_)));
      ...
      p_14514_.addFixer(new AddNewChoices(schema72, "Added 1.14 mobs fix", References.f_16786_));
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema72, "Rename dye items", m_14524_(DyeItemRenameFix.f_15321_)));
      Schema schema73 = p_14514_.addSchema(1801, V1801::new);
      p_14514_.addFixer(new AddNewChoices(schema73, "Added Illager Beast", References.f_16786_));
      Schema schema74 = p_14514_.addSchema(1802, f_14509_);
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema74, "Rename sign blocks & stone slabs", m_14524_(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign"))));
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema74, "Rename sign item & stone slabs", m_14524_(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign"))));
      ...
      p_14514_.addFixer(new AddNewChoices(schema76, "Added Cats", References.f_16786_));
      ...
      p_14514_.addFixer(new AddNewChoices(schema78, "Add POI Blocks", References.f_16781_));
      Schema schema79 = p_14514_.addSchema(1909, V1909::new);
      p_14514_.addFixer(new AddNewChoices(schema79, "Add jigsaw", References.f_16781_));
      Schema schema80 = p_14514_.addSchema(1911, f_14509_);
      p_14514_.addFixer(new ChunkStatusFix2(schema80, false));
      Schema schema81 = p_14514_.addSchema(1917, f_14509_);
      p_14514_.addFixer(new CatTypeFix(schema81, false));
      Schema schema82 = p_14514_.addSchema(1918, f_14509_);
      ...
      p_14514_.addFixer(new AddNewChoices(schema83, "Add campfire", References.f_16781_));
      Schema schema84 = p_14514_.addSchema(1925, f_14509_);
      ...
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema85, "Rename ravager egg item", m_14524_(EntityRavagerRenameFix.f_15591_)));
      Schema schema86 = p_14514_.addSchema(1929, V1929::new);
      p_14514_.addFixer(new AddNewChoices(schema86, "Add Wandering Trader and Trader Llama", References.f_16786_));
      Schema schema87 = p_14514_.addSchema(1931, V1931::new);
      p_14514_.addFixer(new AddNewChoices(schema87, "Added Fox", References.f_16786_));
      Schema schema88 = p_14514_.addSchema(1936, f_14509_);
      p_14514_.addFixer(new OptionsAddTextBackgroundFix(schema88, false));
      Schema schema89 = p_14514_.addSchema(1946, f_14509_);
      p_14514_.addFixer(new ReorganizePoi(schema89, false));
      Schema schema90 = p_14514_.addSchema(1948, f_14509_);
      p_14514_.addFixer(new OminousBannerRenameFix(schema90, false));
      Schema schema91 = p_14514_.addSchema(1953, f_14509_);
      p_14514_.addFixer(new OminousBannerBlockEntityRenameFix(schema91, false));
      Schema schema92 = p_14514_.addSchema(1955, f_14509_);
      ...
      Schema schema93 = p_14514_.addSchema(1961, f_14509_);
      p_14514_.addFixer(new ChunkLightRemoveFix(schema93, false));
      Schema schema94 = p_14514_.addSchema(1963, f_14509_);
      p_14514_.addFixer(new RemoveGolemGossipFix(schema94, false));
      Schema schema95 = p_14514_.addSchema(2100, V2100::new);
      p_14514_.addFixer(new AddNewChoices(schema95, "Added Bee and Bee Stinger", References.f_16786_));
      p_14514_.addFixer(new AddNewChoices(schema95, "Add beehive", References.f_16781_));
      p_14514_.addFixer(new RecipesRenameFix(schema95, false, "Rename sugar recipe", m_14517_("minecraft:sugar", "sugar_from_sugar_cane")));
      p_14514_.addFixer(new AdvancementsRenameFix(schema95, false, "Rename sugar recipe advancement", m_14517_("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
      Schema schema96 = p_14514_.addSchema(2202, f_14509_);
      p_14514_.addFixer(new ChunkBiomeFix(schema96, false));
      Schema schema97 = p_14514_.addSchema(2209, f_14509_);
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema97, "Rename bee_hive item to beehive", m_14517_("minecraft:bee_hive", "minecraft:beehive")));
      p_14514_.addFixer(new BeehivePoiRenameFix(schema97));
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema97, "Rename bee_hive block to beehive", m_14517_("minecraft:bee_hive", "minecraft:beehive")));
      Schema schema98 = p_14514_.addSchema(2211, f_14509_);
      p_14514_.addFixer(new StructureReferenceCountFix(schema98, false));
      Schema schema99 = p_14514_.addSchema(2218, f_14509_);
      ...
      p_14514_.addFixer(new AddNewChoices(schema101, "Added Hoglin", References.f_16786_));
      Schema schema102 = p_14514_.addSchema(2503, f_14509_);
      p_14514_.addFixer(new WallPropertyFix(schema102, false));
      p_14514_.addFixer(new AdvancementsRenameFix(schema102, false, "Composter category change", m_14517_("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
      Schema schema103 = p_14514_.addSchema(2505, V2505::new);
      p_14514_.addFixer(new AddNewChoices(schema103, "Added Piglin", References.f_16786_));
      p_14514_.addFixer(new MemoryExpiryDataFix(schema103, "minecraft:villager"));
      Schema schema104 = p_14514_.addSchema(2508, f_14509_);
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema104, "Renamed fungi items to fungus", m_14524_(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema104, "Renamed fungi blocks to fungus", m_14524_(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      Schema schema105 = p_14514_.addSchema(2509, V2509::new);
      p_14514_.addFixer(new EntityZombifiedPiglinRenameFix(schema105));
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema105, "Rename zombie pigman egg item", m_14524_(EntityZombifiedPiglinRenameFix.f_15814_)));
      Schema schema106 = p_14514_.addSchema(2511, f_14509_);
      p_14514_.addFixer(new EntityProjectileOwnerFix(schema106));
      Schema schema107 = p_14514_.addSchema(2514, f_14509_);
      ...
      Schema schema108 = p_14514_.addSchema(2516, f_14509_);
      ...
      Schema schema109 = p_14514_.addSchema(2518, f_14509_);
      ...
      p_14514_.addFixer(new AddNewChoices(schema110, "Added Strider", References.f_16786_));
      Schema schema111 = p_14514_.addSchema(2522, V2522::new);
      p_14514_.addFixer(new AddNewChoices(schema111, "Added Zoglin", References.f_16786_));
      Schema schema112 = p_14514_.addSchema(2523, f_14509_);
      p_14514_.addFixer(new AttributesRename(schema112));
      Schema schema113 = p_14514_.addSchema(2527, f_14509_);
      p_14514_.addFixer(new BitStorageAlignFix(schema113));
      Schema schema114 = p_14514_.addSchema(2528, f_14509_);
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema114, "Rename soul fire torch and soul fire lantern", m_14524_(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema114, "Rename soul fire torch and soul fire lantern", m_14524_(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      Schema schema115 = p_14514_.addSchema(2529, f_14509_);
      p_14514_.addFixer(new StriderGravityFix(schema115, false));
      Schema schema116 = p_14514_.addSchema(2531, f_14509_);
      p_14514_.addFixer(new RedstoneWireConnectionsFix(schema116));
      Schema schema117 = p_14514_.addSchema(2533, f_14509_);
      p_14514_.addFixer(new VillagerFollowRangeFix(schema117));
      Schema schema118 = p_14514_.addSchema(2535, f_14509_);
      p_14514_.addFixer(new EntityShulkerRotationFix(schema118));
      Schema schema119 = p_14514_.addSchema(2550, f_14509_);
      p_14514_.addFixer(new WorldGenSettingsFix(schema119));
      Schema schema120 = p_14514_.addSchema(2551, V2551::new);
      p_14514_.addFixer(new WriteAndReadFix(schema120, "add types to WorldGenData", References.f_16795_));
      Schema schema121 = p_14514_.addSchema(2552, f_14509_);
      ...
      Schema schema122 = p_14514_.addSchema(2553, f_14509_);
      p_14514_.addFixer(new BiomeFix(schema122, false));
      Schema schema123 = p_14514_.addSchema(2558, f_14509_);
      ...
      p_14514_.addFixer(new AddNewChoices(schema124, "Added Piglin Brute", References.f_16786_));
      Schema schema125 = p_14514_.addSchema(2571, V2571::new);
      p_14514_.addFixer(new AddNewChoices(schema125, "Added Goat", References.f_16786_));
      Schema schema126 = p_14514_.addSchema(2679, f_14509_);
      p_14514_.addFixer(new CauldronRenameFix(schema126, false));
      Schema schema127 = p_14514_.addSchema(2680, f_14509_);
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema127, "Renamed grass path item to dirt path", m_14517_("minecraft:grass_path", "minecraft:dirt_path")));
      p_14514_.addFixer(BlockRenameFixWithJigsaw.m_145163_(schema127, "Renamed grass path block to dirt path", m_14517_("minecraft:grass_path", "minecraft:dirt_path")));
      Schema schema128 = p_14514_.addSchema(2684, V2684::new);
      p_14514_.addFixer(new AddNewChoices(schema128, "Added Sculk Sensor", References.f_16781_));
      Schema schema129 = p_14514_.addSchema(2686, V2686::new);
      p_14514_.addFixer(new AddNewChoices(schema129, "Added Axolotl", References.f_16786_));
      Schema schema130 = p_14514_.addSchema(2688, V2688::new);
      p_14514_.addFixer(new AddNewChoices(schema130, "Added Glow Squid", References.f_16786_));
      p_14514_.addFixer(new AddNewChoices(schema130, "Added Glow Item Frame", References.f_16786_));
      Schema schema131 = p_14514_.addSchema(2690, f_14509_);
      ...
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema131, "Renamed copper block items to new oxidized terms", m_14524_(immutablemap)));
      p_14514_.addFixer(BlockRenameFixWithJigsaw.m_145163_(schema131, "Renamed copper blocks to new oxidized terms", m_14524_(immutablemap)));
      Schema schema132 = p_14514_.addSchema(2691, f_14509_);
      ...
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema132, "Rename copper item suffixes", m_14524_(immutablemap1)));
      p_14514_.addFixer(BlockRenameFixWithJigsaw.m_145163_(schema132, "Rename copper blocks suffixes", m_14524_(immutablemap1)));
      Schema schema133 = p_14514_.addSchema(2696, f_14509_);
      ...
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema133, "Renamed grimstone block items to deepslate", m_14524_(immutablemap2)));
      p_14514_.addFixer(BlockRenameFixWithJigsaw.m_145163_(schema133, "Renamed grimstone blocks to deepslate", m_14524_(immutablemap2)));
      Schema schema134 = p_14514_.addSchema(2700, f_14509_);
      p_14514_.addFixer(BlockRenameFixWithJigsaw.m_145163_(schema134, "Renamed cave vines blocks", m_14524_(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
      Schema schema135 = p_14514_.addSchema(2701, f_14509_);
      p_14514_.addFixer(new SavedDataFeaturePoolElementFix(schema135));
      Schema schema136 = p_14514_.addSchema(2702, f_14509_);
      p_14514_.addFixer(new AbstractArrowPickupFix(schema136));
      Schema schema137 = p_14514_.addSchema(2704, V2704::new);
      p_14514_.addFixer(new AddNewChoices(schema137, "Added Goat", References.f_16786_));
      Schema schema138 = p_14514_.addSchema(2707, V2707::new);
      p_14514_.addFixer(new AddNewChoices(schema138, "Added Marker", References.f_16786_));
      Schema schema139 = p_14514_.addSchema(2710, f_14509_);
      ...
      Schema schema140 = p_14514_.addSchema(2717, f_14509_);
      p_14514_.addFixer(ItemRenameFix.m_16003_(schema140, "Rename azalea_leaves_flowers", m_14524_(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      p_14514_.addFixer(BlockRenameFix.m_14914_(schema140, "Rename azalea_leaves_flowers items", m_14524_(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
   }
