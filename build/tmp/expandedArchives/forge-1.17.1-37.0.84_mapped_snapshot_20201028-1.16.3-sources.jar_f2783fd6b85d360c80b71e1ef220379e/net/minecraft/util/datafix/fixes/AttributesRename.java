...
public class AttributesRename extends DataFix {
   private static final Map<String, String> f_14668_ = ImmutableMap.<String, String>builder().put("generic.maxHealth", "generic.max_health").put("Max Health", "generic.max_health").put("zombie.spawnReinforcements", "zombie.spawn_reinforcements").put("Spawn Reinforcements Chance", "zombie.spawn_reinforcements").put("horse.jumpStrength", "horse.jump_strength").put("Jump Strength", "horse.jump_strength").put("generic.followRange", "generic.follow_range").put("Follow Range", "generic.follow_range").put("generic.knockbackResistance", "generic.knockback_resistance").put("Knockback Resistance", "generic.knockback_resistance").put("generic.movementSpeed", "generic.movement_speed").put("Movement Speed", "generic.movement_speed").put("generic.flyingSpeed", "generic.flying_speed").put("Flying Speed", "generic.flying_speed").put("generic.attackDamage", "generic.attack_damage").put("generic.attackKnockback", "generic.attack_knockback").put("generic.attackSpeed", "generic.attack_speed").put("generic.armorToughness", "generic.armor_toughness").build();
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(this.fixTypeEverywhereTyped("Rename ItemStack Attributes", type, (p_14674_) -> {
         return p_14674_.updateTyped(opticfinder, AttributesRename::m_14675_);
      }), this.fixTypeEverywhereTyped("Rename Entity Attributes", this.getInputSchema().getType(References.f_16786_), AttributesRename::m_14683_), this.fixTypeEverywhereTyped("Rename Player Attributes", this.getInputSchema().getType(References.f_16772_), AttributesRename::m_14683_));
   }

   private static Dynamic<?> m_14677_(Dynamic<?> p_14678_) {
      return DataFixUtils.orElse(p_14678_.asString().result().map((p_14680_) -> {
         return f_14668_.getOrDefault(p_14680_, p_14680_);
         ...
         return p_14694_.update("AttributeModifiers", (p_145080_) -> {
            return DataFixUtils.orElse(p_145080_.asStreamOpt().result().map((p_145074_) -> {
               return p_145074_.map((p_145082_) -> {
                  return p_145082_.update("AttributeName", AttributesRename::m_14677_);
               });
         ...
         return p_14686_.update("Attributes", (p_145076_) -> {
            return DataFixUtils.orElse(p_145076_.asStreamOpt().result().map((p_145072_) -> {
               return p_145072_.map((p_145078_) -> {
                  return p_145078_.update("Name", AttributesRename::m_14677_);
               });
