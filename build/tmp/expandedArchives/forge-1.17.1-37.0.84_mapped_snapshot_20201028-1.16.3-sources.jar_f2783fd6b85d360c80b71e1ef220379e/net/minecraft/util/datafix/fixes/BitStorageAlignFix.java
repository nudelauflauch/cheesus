...
public class BitStorageAlignFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, Dynamic<?>>> type3 = DSL.named(References.f_16783_.typeName(), DSL.remainderType());
      OpticFinder<List<Pair<String, Dynamic<?>>>> opticfinder3 = DSL.fieldFinder("Palette", DSL.list(type3));
      return this.fixTypeEverywhereTyped("BitStorageAlignFix", type, this.getOutputSchema().getType(References.f_16773_), (p_14749_) -> {
         return p_14749_.updateTyped(opticfinder, (p_145120_) -> {
            return this.m_14762_(m_14750_(opticfinder1, opticfinder2, opticfinder3, p_145120_));
         });
      });
   }
         ...
         return p_14765_.update("Heightmaps", (p_145113_) -> {
            return p_145113_.updateMapValues((p_145110_) -> {
               return p_145110_.mapSecond((p_145123_) -> {
                  return m_14776_(p_14765_, p_145123_, 256, 9);
               });
            });
         });
      });
