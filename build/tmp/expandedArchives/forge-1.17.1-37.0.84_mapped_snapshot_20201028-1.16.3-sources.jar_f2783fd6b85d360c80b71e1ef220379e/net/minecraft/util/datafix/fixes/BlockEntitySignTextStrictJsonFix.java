...
public class BlockEntitySignTextStrictJsonFix extends NamedEntityFix {
   public static final Gson f_14861_ = (new GsonBuilder()).registerTypeAdapter(Component.class, new JsonDeserializer<Component>() {
   ...
   private Dynamic<?> m_14870_(Dynamic<?> p_14871_, String p_14872_) {
      ...
      if (!"null".equals(s) && !StringUtils.isEmpty(s)) {
         if (s.charAt(0) == '"' && s.charAt(s.length() - 1) == '"' || s.charAt(0) == '{' && s.charAt(s.length() - 1) == '}') {
            try {
               component = GsonHelper.m_13798_(f_14861_, s, Component.class, true);
               if (component == null) {
      ...
      return p_14871_.set(p_14872_, p_14871_.createString(Component.Serializer.m_130703_(component)));
   }

   protected Typed<?> m_7504_(Typed<?> p_14867_) {
      return p_14867_.update(DSL.remainderFinder(), (p_14869_) -> {
         p_14869_ = this.m_14870_(p_14869_, "Text1");
         p_14869_ = this.m_14870_(p_14869_, "Text2");
         p_14869_ = this.m_14870_(p_14869_, "Text3");
         return this.m_14870_(p_14869_, "Text4");
      });
   }
}