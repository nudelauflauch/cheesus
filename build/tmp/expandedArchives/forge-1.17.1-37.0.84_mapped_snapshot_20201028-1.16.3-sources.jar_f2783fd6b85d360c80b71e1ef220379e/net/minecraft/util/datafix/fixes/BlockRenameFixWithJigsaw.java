...
public abstract class BlockRenameFixWithJigsaw extends BlockRenameFix {
   ...
   public TypeRewriteRule makeRule() {
      TypeReference typereference = References.f_16781_;
      ...
      TypeRewriteRule typerewriterule = this.fixTypeEverywhereTyped(this.f_145148_ + " for jigsaw state", this.getInputSchema().getType(typereference), this.getOutputSchema().getType(typereference), (p_145155_) -> {
