...
public class CauldronRenameFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("cauldron_rename_fix", this.getInputSchema().getType(References.f_16783_), (p_145199_) -> {
         return p_145199_.update(DSL.remainderFinder(), CauldronRenameFix::m_145200_);
      });
   }
}