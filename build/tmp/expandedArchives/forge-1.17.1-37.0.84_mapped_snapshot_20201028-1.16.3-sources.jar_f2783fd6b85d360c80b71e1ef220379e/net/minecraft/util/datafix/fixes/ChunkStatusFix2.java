...
public class ChunkStatusFix2 extends DataFix {
   private static final Map<String, String> f_15255_ = ImmutableMap.<String, String>builder().put("structure_references", "empty").put("biomes", "empty").put("base", "surface").put("carved", "carvers").put("liquid_carved", "liquid_carvers").put("decorated", "features").put("lighted", "light").put("mobs_spawned", "spawn").put("finalized", "heightmaps").put("fullchunk", "full").build();
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkStatusFix2", type, this.getOutputSchema().getType(References.f_16773_), (p_15262_) -> {
         return p_15262_.updateTyped(opticfinder, (p_145232_) -> {
            ...
            String s1 = f_15255_.getOrDefault(s, "empty");
