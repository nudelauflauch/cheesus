...
public class EntityBlockStateFix extends DataFix {
   private static final Map<String, Integer> f_15330_ = DataFixUtils.make(Maps.newHashMap(), (p_15368_) -> {
   ...
   public static int m_15365_(String p_15366_) {
      Integer integer = f_15330_.get(p_15366_);
   ...
   public TypeRewriteRule makeRule() {
      ...
      Function<Typed<?>, Typed<?>> function = (p_15381_) -> {
         return this.m_15337_(p_15381_, "DisplayTile", "DisplayData", "DisplayState");
      };
      Function<Typed<?>, Typed<?>> function1 = (p_15379_) -> {
         return this.m_15337_(p_15379_, "inTile", "inData", "inBlockState");
      };
      Type<Pair<Either<Pair<String, Either<Integer, String>>, Unit>, Dynamic<?>>> type = DSL.and(DSL.optional(DSL.field("inTile", DSL.named(References.f_16787_.typeName(), DSL.or(DSL.intType(), NamespacedSchema.m_17310_())))), DSL.remainderType());
      Function<Typed<?>, Typed<?>> function2 = (p_15348_) -> {
         return p_15348_.update(type.finder(), DSL.remainderType(), Pair::getSecond);
      };
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", schema.getType(References.f_16786_), schema1.getType(References.f_16786_), (p_15373_) -> {
         p_15373_ = this.m_15342_(p_15373_, "minecraft:falling_block", this::m_15335_);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:enderman", (p_145271_) -> {
            return this.m_15337_(p_145271_, "carried", "carriedData", "carriedBlockState");
         });
         p_15373_ = this.m_15342_(p_15373_, "minecraft:arrow", function1);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:spectral_arrow", function1);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:egg", function2);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:ender_pearl", function2);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:fireball", function2);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:potion", function2);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:small_fireball", function2);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:snowball", function2);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:wither_skull", function2);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:xp_bottle", function2);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:commandblock_minecart", function);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:minecart", function);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:chest_minecart", function);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:furnace_minecart", function);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:tnt_minecart", function);
         p_15373_ = this.m_15342_(p_15373_, "minecraft:hopper_minecart", function);
         return this.m_15342_(p_15373_, "minecraft:spawner_minecart", function);
      });
   }

   private Typed<?> m_15335_(Typed<?> p_15336_) {
      Type<Either<Pair<String, Either<Integer, String>>, Unit>> type = DSL.optional(DSL.field("Block", DSL.named(References.f_16787_.typeName(), DSL.or(DSL.intType(), NamespacedSchema.m_17310_()))));
      Type<Either<Pair<String, Dynamic<?>>, Unit>> type1 = DSL.optional(DSL.field("BlockState", DSL.named(References.f_16783_.typeName(), DSL.remainderType())));
      ...
      return p_15336_.update(type.finder(), type1, (p_15355_) -> {
         ...
         return Either.left(Pair.of(References.f_16783_.typeName(), BlockStateData.m_14952_(i << 4 | j)));
      }).set(DSL.remainderFinder(), dynamic.remove("Data").remove("TileID").remove("Tile"));
   }

   private Typed<?> m_15337_(Typed<?> p_15338_, String p_15339_, String p_15340_, String p_15341_) {
      Type<Pair<String, Either<Integer, String>>> type = DSL.field(p_15339_, DSL.named(References.f_16787_.typeName(), DSL.or(DSL.intType(), NamespacedSchema.m_17310_())));
      Type<Pair<String, Dynamic<?>>> type1 = DSL.field(p_15341_, DSL.named(References.f_16783_.typeName(), DSL.remainderType()));
      ...
      return p_15338_.update(type.finder(), type1, (p_15362_) -> {
         ...
         return Pair.of(References.f_16783_.typeName(), BlockStateData.m_14952_(i << 4 | j));
      }).set(DSL.remainderFinder(), dynamic.remove(p_15340_));
   }

   private Typed<?> m_15342_(Typed<?> p_15343_, String p_15344_, Function<Typed<?>, Typed<?>> p_15345_) {
      Type<?> type = this.getInputSchema().getChoiceType(References.f_16786_, p_15344_);
      Type<?> type1 = this.getOutputSchema().getChoiceType(References.f_16786_, p_15344_);
