...
public class EntityRavagerRenameFix extends SimplestEntityRenameFix {
   public static final Map<String, String> f_15591_ = ImmutableMap.<String, String>builder().put("minecraft:illager_beast_spawn_egg", "minecraft:ravager_spawn_egg").build();

   public EntityRavagerRenameFix(Schema p_15594_, boolean p_15595_) {
      super("EntityRavagerRenameFix", p_15594_, p_15595_);
   }

   protected String m_7476_(String p_15597_) {
