...
public abstract class EntityRenameFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhere(this.f_15616_, taggedchoicetype, taggedchoicetype1, (p_15624_) -> {
         return (p_145311_) -> {
            ...
            Pair<String, Typed<?>> pair = this.m_6911_(s, this.m_15630_(p_145311_.getSecond(), p_15624_, type));
   ...
   protected abstract Pair<String, Typed<?>> m_6911_(String p_15634_, Typed<?> p_15635_);
}