...
public class EntityRidingToPassengersFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> type = schema.getTypeRaw(References.f_16785_);
      Type<?> type1 = schema1.getTypeRaw(References.f_16785_);
      Type<?> type2 = schema.getTypeRaw(References.f_16786_);
      return this.m_15641_(schema, schema1, type, type1, type2);
   }
   ...
   private <OldEntityTree, NewEntityTree, Entity> TypeRewriteRule m_15641_(Schema p_15642_, Schema p_15643_, Type<OldEntityTree> p_15644_, Type<NewEntityTree> p_15645_, Type<Entity> p_15646_) {
      Type<Pair<String, Pair<Either<OldEntityTree, Unit>, Entity>>> type = DSL.named(References.f_16785_.typeName(), DSL.and(DSL.optional(DSL.field("Riding", p_15644_)), p_15646_));
      Type<Pair<String, Pair<Either<List<NewEntityTree>, Unit>, Entity>>> type1 = DSL.named(References.f_16785_.typeName(), DSL.and(DSL.optional(DSL.field("Passengers", DSL.list(p_15645_))), p_15646_));
      Type<?> type2 = p_15642_.getType(References.f_16785_);
      Type<?> type3 = p_15643_.getType(References.f_16785_);
         ...
         return TypeRewriteRule.seq(this.fixTypeEverywhere("EntityRidingToPassengerFix", type, type1, (p_15653_) -> {
            return (p_145320_) -> {
               ...
               while(true) {
                  ...
                  optional = Optional.of(Pair.of(References.f_16785_.typeName(), Pair.of(either, pair.getSecond().getSecond())));
