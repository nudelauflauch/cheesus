...
public class FurnaceRecipeFix extends DataFix {
   ...
   private <R> TypeRewriteRule m_15849_(Type<R> p_15850_) {
      ...
      OpticFinder<?> opticfinder = DSL.namedChoice("minecraft:furnace", this.getInputSchema().getChoiceType(References.f_16781_, "minecraft:furnace"));
      OpticFinder<?> opticfinder1 = DSL.namedChoice("minecraft:blast_furnace", this.getInputSchema().getChoiceType(References.f_16781_, "minecraft:blast_furnace"));
      OpticFinder<?> opticfinder2 = DSL.namedChoice("minecraft:smoker", this.getInputSchema().getChoiceType(References.f_16781_, "minecraft:smoker"));
      Type<?> type1 = this.getOutputSchema().getChoiceType(References.f_16781_, "minecraft:furnace");
      Type<?> type2 = this.getOutputSchema().getChoiceType(References.f_16781_, "minecraft:blast_furnace");
      Type<?> type3 = this.getOutputSchema().getChoiceType(References.f_16781_, "minecraft:smoker");
      Type<?> type4 = this.getInputSchema().getType(References.f_16781_);
      Type<?> type5 = this.getOutputSchema().getType(References.f_16781_);
      return this.fixTypeEverywhereTyped("FurnaceRecipesFix", type4, type5, (p_15848_) -> {
         return p_15848_.updateTyped(opticfinder, type1, (p_145372_) -> {
            return this.m_15851_(p_15850_, type, p_145372_);
         }).updateTyped(opticfinder1, type2, (p_145368_) -> {
            return this.m_15851_(p_15850_, type, p_145368_);
         }).updateTyped(opticfinder2, type3, (p_145364_) -> {
            return this.m_15851_(p_15850_, type, p_145364_);
         });
      });
   }
