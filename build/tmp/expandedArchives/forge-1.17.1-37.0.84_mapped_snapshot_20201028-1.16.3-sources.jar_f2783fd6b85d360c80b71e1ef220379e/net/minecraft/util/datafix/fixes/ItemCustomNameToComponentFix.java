   ...
   private Dynamic<?> m_15934_(Dynamic<?> p_15935_) {
      ...
      if (optional.isPresent()) {
         ...
         if (optional1.isPresent()) {
            dynamic = dynamic.set("Name", dynamic.createString(Component.Serializer.m_130703_(new TextComponent(optional1.get()))));
         } else {
            Optional<String> optional2 = dynamic.get("LocName").asString().result();
            if (optional2.isPresent()) {
               dynamic = dynamic.set("Name", dynamic.createString(Component.Serializer.m_130703_(new TranslatableComponent(optional2.get()))));
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemCustomNameToComponentFix", type, (p_15931_) -> {
         return p_15931_.updateTyped(opticfinder, (p_145384_) -> {
            return p_145384_.update(DSL.remainderFinder(), this::m_15934_);
         });
      });
   }
}