...
public class ItemIdFix extends DataFix {
   private static final Int2ObjectMap<String> f_15937_ = DataFixUtils.make(new Int2ObjectOpenHashMap<>(), (p_15953_) -> {
   ...
   public static String m_15942_(int p_15943_) {
      return f_15937_.get(p_15943_);
   }

   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> type = DSL.or(DSL.intType(), DSL.named(References.f_16788_.typeName(), NamespacedSchema.m_17310_()));
      Type<Pair<String, String>> type1 = DSL.named(References.f_16788_.typeName(), NamespacedSchema.m_17310_());
      OpticFinder<Either<Integer, Pair<String, String>>> opticfinder = DSL.fieldFinder("id", type);
      return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.f_16782_), this.getOutputSchema().getType(References.f_16782_), (p_15947_) -> {
         return p_15947_.update(opticfinder, type1, (p_145386_) -> {
            return p_145386_.map((p_145390_) -> {
               return Pair.of(References.f_16788_.typeName(), m_15942_(p_145390_));
            }, (p_145388_) -> {
               return p_145388_;
            });
         });
