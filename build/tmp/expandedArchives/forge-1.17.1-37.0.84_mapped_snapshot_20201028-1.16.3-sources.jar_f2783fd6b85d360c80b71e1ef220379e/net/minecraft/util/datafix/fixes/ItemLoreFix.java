...
public class ItemLoreFix extends DataFix {
            ...
            return p_145392_.update(DSL.remainderFinder(), (p_145394_) -> {
               return p_145394_.update("display", (p_145396_) -> {
                  return p_145396_.update("Lore", (p_145398_) -> {
                     return DataFixUtils.orElse(p_145398_.asStreamOpt().map(ItemLoreFix::m_15969_).map(p_145398_::createList).result(), p_145398_);
                  });
               });
            });
         });
   ...
   private static <T> Stream<Dynamic<T>> m_15969_(Stream<Dynamic<T>> p_15970_) {
      return p_15970_.map((p_15966_) -> {
         return DataFixUtils.orElse(p_15966_.asString().map(ItemLoreFix::m_15967_).map(p_15966_::createString).result(), p_15966_);
      });
   }

   private static String m_15967_(String p_15968_) {
      return Component.Serializer.m_130703_(new TextComponent(p_15968_));
   }
}