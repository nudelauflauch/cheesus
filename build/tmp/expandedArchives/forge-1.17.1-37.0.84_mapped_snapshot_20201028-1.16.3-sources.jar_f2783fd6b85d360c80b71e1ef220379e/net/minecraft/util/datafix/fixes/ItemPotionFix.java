...
public class ItemPotionFix extends DataFix {
   private static final int f_145400_ = 16384;
   private static final String[] f_15987_ = DataFixUtils.make(new String[128], (p_15997_) -> {
   ...
   public static final String f_145399_ = "minecraft:water";
            ...
            if (optional1.isPresent()) {
               ...
               if (!optional2.isPresent()) {
                  ...
                  if ((short1 & 16384) == 16384) {
                     typed = typed.set(opticfinder, Pair.of(References.f_16788_.typeName(), "minecraft:splash_potion"));
                  }
               }
