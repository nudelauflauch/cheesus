...
public class ItemStackTheFlatteningFix extends DataFix {
   private static final Map<String, String> f_16109_ = DataFixUtils.make(Maps.newHashMap(), (p_16126_) -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, (p_16119_) -> {
         ...
         if (!optional.isPresent()) {
            ...
            String s = m_16122_(optional.get().getSecond(), i);
            if (s != null) {
               typed = p_16119_.set(opticfinder, Pair.of(References.f_16788_.typeName(), s));
            }

            if (f_16111_.contains(optional.get().getSecond())) {
   ...
   @Nullable
   public static String m_16122_(@Nullable String p_16123_, int p_16124_) {
      if (f_16110_.contains(p_16123_)) {
         String s = f_16109_.get(p_16123_ + "." + p_16124_);
         return s == null ? f_16109_.get(p_16123_ + ".0") : s;
      } else {
         return null;
      }
   }
