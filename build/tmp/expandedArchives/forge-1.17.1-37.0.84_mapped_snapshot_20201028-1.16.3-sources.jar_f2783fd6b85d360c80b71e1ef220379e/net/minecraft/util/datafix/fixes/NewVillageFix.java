...
public class NewVillageFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      CompoundListType<String, ?> compoundlisttype = DSL.compoundList(DSL.string(), this.getInputSchema().getType(References.f_16790_));
      OpticFinder<? extends List<? extends Pair<String, ?>>> opticfinder = compoundlisttype.finder();
      return this.m_16498_(compoundlisttype);
   }

   private <SF> TypeRewriteRule m_16498_(CompoundListType<String, SF> p_16499_) {
      Type<?> type = this.getInputSchema().getType(References.f_16773_);
      Type<?> type1 = this.getInputSchema().getType(References.f_16790_);
      ...
      return TypeRewriteRule.seq(this.fixTypeEverywhereTyped("NewVillageFix", type, (p_16483_) -> {
         ...
         return p_16497_.update(DSL.remainderFinder(), (p_145537_) -> {
            return p_145537_.update("id", (p_145548_) -> {
               return Objects.equals(NamespacedSchema.m_17311_(p_145548_.asString("")), "minecraft:new_village") ? p_145548_.createString("minecraft:village") : p_145548_;
            });
         });
      }));
   }
