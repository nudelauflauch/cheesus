...
public class OptionsAddTextBackgroundFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("OptionsAddTextBackgroundFix", this.getInputSchema().getType(References.f_16775_), (p_16610_) -> {
         return p_16610_.update(DSL.remainderFinder(), (p_145567_) -> {
            return DataFixUtils.orElse(p_145567_.get("chatOpacity").asString().map((p_145570_) -> {
               return p_145567_.set("textBackgroundOpacity", p_145567_.createDouble(this.m_16616_(p_145570_)));
            }).result(), p_145567_);
         });
      });
   }
