...
public class SavedDataUUIDFix extends AbstractUUIDFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("SavedDataUUIDFix", this.getInputSchema().getType(this.f_14569_), (p_16865_) -> {
                  ...
                  return p_145676_.createList(p_145676_.asStream().map((p_145678_) -> {
                     return p_145678_.update("HeroesOfTheVillage", (p_145680_) -> {
                        return p_145680_.createList(p_145680_.asStream().map((p_145682_) -> {
                           return m_14621_(p_145682_, "UUIDMost", "UUIDLeast").orElseGet(() -> {
                              f_14568_.warn("HeroesOfTheVillage contained invalid UUIDs.");
                              return p_145682_;
                           });
                        }));
                     });
