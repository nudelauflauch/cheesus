...
public abstract class SimpleEntityRenameFix extends EntityRenameFix {
   ...
   protected Pair<String, Typed<?>> m_6911_(String p_16905_, Typed<?> p_16906_) {
      Pair<String, Dynamic<?>> pair = this.m_6942_(p_16905_, p_16906_.getOrCreate(DSL.remainderFinder()));
      return Pair.of(pair.getFirst(), p_16906_.set(DSL.remainderFinder(), pair.getSecond()));
   }

   protected abstract Pair<String, Dynamic<?>> m_6942_(String p_16907_, Dynamic<?> p_16908_);
}