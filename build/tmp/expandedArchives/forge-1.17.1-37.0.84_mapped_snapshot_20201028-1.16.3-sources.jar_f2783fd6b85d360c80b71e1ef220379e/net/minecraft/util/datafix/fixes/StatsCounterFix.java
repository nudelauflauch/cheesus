            ...
            while(true) {
               ...
               while(true) {
                  ...
                  if (entry.getValue().asNumber().result().isPresent()) {
                     ...
                     if (!f_16932_.contains(s)) {
                        if (f_16933_.containsKey(s)) {
                           s1 = "minecraft:custom";
                           s2 = f_16933_.get(s);
                           break;
                        }
                        ...
                        if (i >= 0) {
                           ...
                           if ("stat.mineBlock".equals(s3)) {
                              s1 = "minecraft:mined";
                              s2 = this.m_16950_(s.substring(i + 1).replace('.', ':'));
                              break;
                           }

                           if (f_16934_.containsKey(s3)) {
                              s1 = f_16934_.get(s3);
                              String s6 = s.substring(i + 1).replace('.', ':');
                              String s5 = this.m_16948_(s6);
                              s2 = s5 == null ? s6 : s5;
                              break;
                           }

                           if (f_16935_.containsKey(s3)) {
                              s1 = f_16935_.get(s3);
                              String s4 = s.substring(i + 1).replace('.', ':');
                              s2 = f_16936_.getOrDefault(s4, s4);
                              break;
                           }
                        }
                     }
