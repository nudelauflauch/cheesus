...
public class TeamDisplayNameFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, Dynamic<?>>> type = DSL.named(References.f_16792_.typeName(), DSL.remainderType());
      if (!Objects.equals(type, this.getInputSchema().getType(References.f_16792_))) {
               ...
               return p_145726_.mapSecond((p_145728_) -> {
                  return p_145728_.update("DisplayName", (p_145731_) -> {
                     return DataFixUtils.orElse(p_145731_.asString().map((p_145733_) -> {
                        return Component.Serializer.m_130703_(new TextComponent(p_145733_));
