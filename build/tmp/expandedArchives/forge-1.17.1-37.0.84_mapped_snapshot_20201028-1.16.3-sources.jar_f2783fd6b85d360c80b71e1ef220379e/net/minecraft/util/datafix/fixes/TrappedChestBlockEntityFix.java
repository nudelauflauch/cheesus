...
public class TrappedChestBlockEntityFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      if (!(type2 instanceof ListType)) {
         ...
         Type<?> type3 = this.getInputSchema().getType(References.f_16773_);
         ...
         if (!(type4 instanceof ListType)) {
            ...
            return TypeRewriteRule.seq((new AddNewChoices(this.getOutputSchema(), "AddTrappedChestFix", References.f_16781_)).makeRule(), this.fixTypeEverywhereTyped("Trapped Chest fix", type3, (p_17031_) -> {
               return p_17031_.updateTyped(opticfinder1, (p_145746_) -> {
                  ...
                  if (!optional.isPresent()) {
                     ...
                     for(Typed<?> typed : list) {
                        ...
                        if (!trappedchestblockentityfix$trappedchestsection.m_16298_()) {
                           for(int i = 0; i < 4096; ++i) {
                              int j = trappedchestblockentityfix$trappedchestsection.m_16302_(i);
                              if (trappedchestblockentityfix$trappedchestsection.m_17053_(j)) {
                                 intset.add(trappedchestblockentityfix$trappedchestsection.m_16301_() << 12 | i);
                              }
                           }
                        }
                     }
                     ...
                     return p_145746_.updateTyped(opticfinder, (p_145752_) -> {
                        return p_145752_.updateTyped(taggedchoicetype.finder(), (p_145741_) -> {
                           ...
                           return intset.contains(LeavesFix.m_16210_(i1, j1, k1)) ? p_145741_.update(taggedchoicetype.finder(), (p_145754_) -> {
