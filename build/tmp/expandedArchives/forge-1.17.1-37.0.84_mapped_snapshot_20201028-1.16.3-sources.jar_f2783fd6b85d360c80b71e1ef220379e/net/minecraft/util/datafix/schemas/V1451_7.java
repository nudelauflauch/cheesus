...
public class V1451_7 extends NamespacedSchema {
   ...
   public void registerTypes(Schema p_17549_, Map<String, Supplier<TypeTemplate>> p_17550_, Map<String, Supplier<TypeTemplate>> p_17551_) {
      ...
      p_17549_.registerType(false, References.f_16790_, () -> {
         return DSL.optionalFields("Children", DSL.list(DSL.optionalFields("CA", References.f_16783_.in(p_17549_), "CB", References.f_16783_.in(p_17549_), "CC", References.f_16783_.in(p_17549_), "CD", References.f_16783_.in(p_17549_))));
      });
   }
}