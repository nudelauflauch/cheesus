...
public class V1906 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_17780_) {
      ...
      m_17775_(p_17780_, map, "minecraft:barrel");
      m_17775_(p_17780_, map, "minecraft:smoker");
      m_17775_(p_17780_, map, "minecraft:blast_furnace");
      p_17780_.register(map, "minecraft:lectern", (p_17774_) -> {
         return DSL.optionalFields("Book", References.f_16782_.in(p_17780_));
      });
   ...
   protected static void m_17775_(Schema p_17776_, Map<String, Supplier<TypeTemplate>> p_17777_, String p_17778_) {
      p_17776_.register(p_17777_, p_17778_, () -> {
         return DSL.optionalFields("Items", DSL.list(References.f_16782_.in(p_17776_)));
      });
   }
}