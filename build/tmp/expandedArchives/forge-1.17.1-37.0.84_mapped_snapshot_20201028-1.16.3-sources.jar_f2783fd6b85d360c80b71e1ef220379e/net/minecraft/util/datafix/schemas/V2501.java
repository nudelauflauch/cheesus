...
public class V2501 extends NamespacedSchema {
   ...
   private static void m_17852_(Schema p_17853_, Map<String, Supplier<TypeTemplate>> p_17854_, String p_17855_) {
      p_17853_.register(p_17854_, p_17855_, () -> {
         return DSL.optionalFields("Items", DSL.list(References.f_16782_.in(p_17853_)), "RecipesUsed", DSL.compoundList(References.f_16793_.in(p_17853_), DSL.constType(DSL.intType())));
      });
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_17857_) {
      ...
      m_17852_(p_17857_, map, "minecraft:furnace");
      m_17852_(p_17857_, map, "minecraft:smoker");
      m_17852_(p_17857_, map, "minecraft:blast_furnace");
      return map;
   }
}