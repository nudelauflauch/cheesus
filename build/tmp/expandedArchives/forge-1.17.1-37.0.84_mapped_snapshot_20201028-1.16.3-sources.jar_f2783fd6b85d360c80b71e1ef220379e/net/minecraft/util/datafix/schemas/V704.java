...
public class V704 extends Schema {
   protected static final Map<String, String> f_18032_ = DataFixUtils.make(() -> {
   ...
   protected static final HookFunction f_18033_ = new HookFunction() {
      public <T> T apply(DynamicOps<T> p_18070_, T p_18071_) {
         return V99.m_18205_(new Dynamic<>(p_18070_, p_18071_), V704.f_18032_, "ArmorStand");
      }
   };
   ...
   protected static void m_18043_(Schema p_18044_, Map<String, Supplier<TypeTemplate>> p_18045_, String p_18046_) {
      p_18044_.register(p_18045_, p_18046_, () -> {
         return DSL.optionalFields("Items", DSL.list(References.f_16782_.in(p_18044_)));
      });
   }

   public Type<?> getChoiceType(TypeReference p_18060_, String p_18061_) {
      return Objects.equals(p_18060_.typeName(), References.f_16781_.typeName()) ? super.getChoiceType(p_18060_, NamespacedSchema.m_17311_(p_18061_)) : super.getChoiceType(p_18060_, p_18061_);
   }

   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_18063_) {
      Map<String, Supplier<TypeTemplate>> map = Maps.newHashMap();
      m_18043_(p_18063_, map, "minecraft:furnace");
      m_18043_(p_18063_, map, "minecraft:chest");
      p_18063_.registerSimple(map, "minecraft:ender_chest");
      p_18063_.register(map, "minecraft:jukebox", (p_18058_) -> {
         return DSL.optionalFields("RecordItem", References.f_16782_.in(p_18063_));
      });
      m_18043_(p_18063_, map, "minecraft:dispenser");
      m_18043_(p_18063_, map, "minecraft:dropper");
      p_18063_.registerSimple(map, "minecraft:sign");
      p_18063_.register(map, "minecraft:mob_spawner", (p_18055_) -> {
         return References.f_16789_.in(p_18063_);
      });
      p_18063_.registerSimple(map, "minecraft:noteblock");
      p_18063_.registerSimple(map, "minecraft:piston");
      m_18043_(p_18063_, map, "minecraft:brewing_stand");
      ...
      m_18043_(p_18063_, map, "minecraft:hopper");
      p_18063_.registerSimple(map, "minecraft:comparator");
      p_18063_.register(map, "minecraft:flower_pot", (p_18042_) -> {
         return DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), References.f_16788_.in(p_18063_)));
      });
   ...
   public void registerTypes(Schema p_18065_, Map<String, Supplier<TypeTemplate>> p_18066_, Map<String, Supplier<TypeTemplate>> p_18067_) {
      ...
      p_18065_.registerType(false, References.f_16781_, () -> {
         return DSL.taggedChoiceLazy("id", NamespacedSchema.m_17310_(), p_18067_);
      });
      p_18065_.registerType(true, References.f_16782_, () -> {
         return DSL.hook(DSL.optionalFields("id", References.f_16788_.in(p_18065_), "tag", DSL.optionalFields("EntityTag", References.f_16785_.in(p_18065_), "BlockEntityTag", References.f_16781_.in(p_18065_), "CanDestroy", DSL.list(References.f_16787_.in(p_18065_)), "CanPlaceOn", DSL.list(References.f_16787_.in(p_18065_)), "Items", DSL.list(References.f_16782_.in(p_18065_)))), f_18033_, HookFunction.IDENTITY);
      });
   }
}