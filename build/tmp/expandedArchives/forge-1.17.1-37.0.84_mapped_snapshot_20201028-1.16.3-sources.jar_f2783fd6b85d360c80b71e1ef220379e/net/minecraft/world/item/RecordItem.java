...
public class RecordItem extends Item {
   ...
   public InteractionResult m_6225_(UseOnContext p_43048_) {
      Level level = p_43048_.m_43725_();
      BlockPos blockpos = p_43048_.m_8083_();
      ...
      if (blockstate.m_60713_(Blocks.f_50131_) && !blockstate.m_61143_(JukeboxBlock.f_54254_)) {
         ...
         if (!level.f_46443_) {
            ((JukeboxBlock)Blocks.f_50131_).m_54269_(level, blockpos, blockstate, itemstack);
            level.m_5898_((Player)null, 1010, blockpos, Item.m_41393_(this));
