...
public class TallFlowerBlock extends DoublePlantBlock implements BonemealableBlock {
   ...
   public boolean m_5491_(Level p_57308_, Random p_57309_, BlockPos p_57310_, BlockState p_57311_) {
      return true;
   }

   public void m_7719_(ServerLevel p_57298_, Random p_57299_, BlockPos p_57300_, BlockState p_57301_) {
      m_49840_(p_57298_, p_57300_, new ItemStack(this));
   }
}