...
public class DirectionProperty extends EnumProperty<Direction> {
   ...
   public static DirectionProperty m_156003_(String p_156004_) {
      return m_61546_(p_156004_, Predicates.alwaysTrue());
   }

   public static DirectionProperty m_61546_(String p_61547_, Predicate<Direction> p_61548_) {
      return m_61543_(p_61547_, Arrays.stream(Direction.values()).filter(p_61548_).collect(Collectors.toList()));
   }

   public static DirectionProperty m_61549_(String p_61550_, Direction... p_61551_) {
      return m_61543_(p_61550_, Lists.newArrayList(p_61551_));
   }
