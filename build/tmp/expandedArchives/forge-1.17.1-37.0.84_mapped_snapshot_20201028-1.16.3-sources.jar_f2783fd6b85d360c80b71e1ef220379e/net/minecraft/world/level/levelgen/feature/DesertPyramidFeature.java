...
public class DesertPyramidFeature extends StructureFeature<NoneFeatureConfiguration> {
   ...
   public static class FeatureStart extends StructureStart<NoneFeatureConfiguration> {
      ...
      public void m_142743_(RegistryAccess p_159563_, ChunkGenerator p_159564_, StructureManager p_159565_, ChunkPos p_159566_, Biome p_159567_, NoneFeatureConfiguration p_159568_, LevelHeightAccessor p_159569_) {
         DesertPyramidPiece desertpyramidpiece = new DesertPyramidPiece(this.f_73564_, p_159566_.m_45604_(), p_159566_.m_45605_());
         this.m_142679_(desertpyramidpiece);
      }
   }
}