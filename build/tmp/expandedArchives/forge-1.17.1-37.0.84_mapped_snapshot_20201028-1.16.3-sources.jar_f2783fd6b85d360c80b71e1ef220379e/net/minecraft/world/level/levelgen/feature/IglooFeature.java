...
public class IglooFeature extends StructureFeature<NoneFeatureConfiguration> {
   ...
   public static class FeatureStart extends StructureStart<NoneFeatureConfiguration> {
      ...
      public void m_142743_(RegistryAccess p_159901_, ChunkGenerator p_159902_, StructureManager p_159903_, ChunkPos p_159904_, Biome p_159905_, NoneFeatureConfiguration p_159906_, LevelHeightAccessor p_159907_) {
         BlockPos blockpos = new BlockPos(p_159904_.m_45604_(), 90, p_159904_.m_45605_());
         Rotation rotation = Rotation.m_55956_(this.f_73564_);
         IglooPieces.m_162434_(p_159903_, blockpos, rotation, this, this.f_73564_);
      }
   }
}