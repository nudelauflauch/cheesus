...
public class OreFeature extends Feature<OreConfiguration> {
   ...
   public boolean m_142674_(FeaturePlaceContext<OreConfiguration> p_160177_) {
      ...
      OreConfiguration oreconfiguration = p_160177_.m_159778_();
      ...
      int j = 2;
      double d4 = (double)(blockpos.m_123342_() + random.nextInt(3) - 2);
      double d5 = (double)(blockpos.m_123342_() + random.nextInt(3) - 2);
      ...
      for(int l1 = k; l1 <= k + j1; ++l1) {
         for(int i2 = i1; i2 <= i1 + j1; ++i2) {
            if (l <= worldgenlevel.m_6924_(Heightmap.Types.OCEAN_FLOOR_WG, l1, i2)) {
               return this.m_66532_(worldgenlevel, random, oreconfiguration, d0, d1, d2, d3, d4, d5, k, l, i1, j1, k1);
            }
         }
      }
   ...
   protected boolean m_66532_(WorldGenLevel p_66533_, Random p_66534_, OreConfiguration p_66535_, double p_66536_, double p_66537_, double p_66538_, double p_66539_, double p_66540_, double p_66541_, int p_66542_, int p_66543_, int p_66544_, int p_66545_, int p_66546_) {
      int i = 0;
      ...
      for(int k = 0; k < j; ++k) {
         ...
         double d0 = Mth.m_14139_((double)f, p_66536_, p_66537_);
         double d1 = Mth.m_14139_((double)f, p_66540_, p_66541_);
         double d2 = Mth.m_14139_((double)f, p_66538_, p_66539_);
      ...
      try {
         for(int j4 = 0; j4 < j; ++j4) {
            ...
            if (!(d9 < 0.0D)) {
               ...
               int k4 = Math.max(Mth.m_14107_(d11 - d9), p_66542_);
               int l = Math.max(Mth.m_14107_(d13 - d9), p_66543_);
               int i1 = Math.max(Mth.m_14107_(d15 - d9), p_66544_);
                                 ...
                                 if (!bitset.get(l2)) {
                                    ...
                                    if (p_66533_.m_180807_(blockpos$mutableblockpos)) {
                                       ...
                                       if (levelchunksection != LevelChunk.f_62770_) {
                                          ...
                                          for(OreConfiguration.TargetBlockState oreconfiguration$targetblockstate : p_66535_.f_161005_) {
                                             if (m_160169_(blockstate, bulksectionaccess::m_156110_, p_66534_, p_66535_, oreconfiguration$targetblockstate, blockpos$mutableblockpos)) {
   ...
   public static boolean m_160169_(BlockState p_160170_, Function<BlockPos, BlockState> p_160171_, Random p_160172_, OreConfiguration p_160173_, OreConfiguration.TargetBlockState p_160174_, BlockPos.MutableBlockPos p_160175_) {
      if (!p_160174_.f_161032_.m_7715_(p_160170_, p_160172_)) {
         return false;
      } else if (m_160178_(p_160172_, p_160173_.f_161006_)) {
         return true;
      } else {
         return !m_159750_(p_160171_, p_160175_);
      }
   }

   protected static boolean m_160178_(Random p_160179_, float p_160180_) {
      if (p_160180_ <= 0.0F) {
         return true;
