...
public class AddEdgeLayer {
   public static enum CoolWarm implements CastleTransformer {
      ...
      public int m_6949_(Context p_76576_, int p_76577_, int p_76578_, int p_76579_, int p_76580_, int p_76581_) {
   ...
   public static enum HeatIce implements CastleTransformer {
      ...
      public int m_6949_(Context p_76592_, int p_76593_, int p_76594_, int p_76595_, int p_76596_, int p_76597_) {
   ...
   public static enum IntroduceSpecial implements C0Transformer {
      ...
      public int m_8006_(Context p_76608_, int p_76609_) {
         if (!Layers.m_76751_(p_76609_) && p_76608_.m_5826_(13) == 0) {
            p_76609_ |= 1 + p_76608_.m_5826_(15) << 8 & 3840;
         }
