...
public class FillPlayerHead extends LootItemConditionalFunction {
   ...
   public ItemStack m_7372_(ItemStack p_80608_, LootContext p_80609_) {
      if (p_80608_.m_150930_(Items.f_42680_)) {
         Entity entity = p_80609_.m_78953_(this.f_80602_.m_79003_());
         if (entity instanceof Player) {
            GameProfile gameprofile = ((Player)entity).m_36316_();
            p_80608_.m_41784_().m_128365_("SkullOwner", NbtUtils.m_129230_(new CompoundTag(), gameprofile));
         }
      }
   ...
   public static class Serializer extends LootItemConditionalFunction.Serializer<FillPlayerHead> {
      public void m_6170_(JsonObject p_80619_, FillPlayerHead p_80620_, JsonSerializationContext p_80621_) {
         ...
         p_80619_.add("entity", p_80621_.serialize(p_80620_.f_80602_));
      }

      public FillPlayerHead m_6821_(JsonObject p_80615_, JsonDeserializationContext p_80616_, LootItemCondition[] p_80617_) {
         LootContext.EntityTarget lootcontext$entitytarget = GsonHelper.m_13836_(p_80615_, "entity", p_80616_, LootContext.EntityTarget.class);
