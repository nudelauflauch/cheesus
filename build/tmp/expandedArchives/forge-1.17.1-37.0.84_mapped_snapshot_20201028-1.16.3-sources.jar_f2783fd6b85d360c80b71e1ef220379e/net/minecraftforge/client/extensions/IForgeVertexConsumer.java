...
public interface IForgeVertexConsumer
{
    ...
    default void putBulkData(PoseStack.Pose matrixEntry, BakedQuad bakedQuad, float[] baseBrightness, float red, float green, float blue, float alpha, int[] lightmapCoords, int overlayCoords, boolean readExistingColor) {
        ...
        normal.m_122249_(matrixEntry.m_85864_());
        ...
        try (MemoryStack memorystack = MemoryStack.stackPush()) {
            ...
            for(int v = 0; v < vertexCount; ++v) {
                ...
                applyBakedNormals(normal, bytebuffer, matrixEntry.m_85864_());
                ((VertexConsumer)this).m_5954_(pos.m_123601_(), pos.m_123615_(), pos.m_123616_(), cr, cg, cb, ca, f9, f10, overlayCoords, lightmapCoord, normal.m_122239_(), normal.m_122260_(), normal.m_122269_());
            }
        }
    }
