...
public abstract class ScrollPanel extends AbstractContainerEventHandler implements Widget, NarratableEntry
{
    ...
    public boolean m_6348_(double p_mouseReleased_1_, double p_mouseReleased_3_, int p_mouseReleased_5_) {
        if (super.m_6348_(p_mouseReleased_1_, p_mouseReleased_3_, p_mouseReleased_5_))
            return true;
    ...
    public void m_6305_(PoseStack matrix, int mouseX, int mouseY, float partialTicks)
    {
        ...
        GL11.glScissor((int)(left  * scale), (int)(client.m_91268_().m_85442_() - (bottom * scale)),
        ...
        if (extraHeight > 0)
        {
            ...
            worldr.m_5483_(barLeft,            this.bottom, 0.0D).m_6122_(0x00, 0x00, 0x00, 0xFF).m_5752_();
            worldr.m_5483_(barLeft + barWidth, this.bottom, 0.0D).m_6122_(0x00, 0x00, 0x00, 0xFF).m_5752_();
            worldr.m_5483_(barLeft + barWidth, this.top,    0.0D).m_6122_(0x00, 0x00, 0x00, 0xFF).m_5752_();
            worldr.m_5483_(barLeft,            this.top,    0.0D).m_6122_(0x00, 0x00, 0x00, 0xFF).m_5752_();
            tess.m_85914_();
            worldr.m_166779_(VertexFormat.Mode.QUADS, DefaultVertexFormat.f_85815_);
            worldr.m_5483_(barLeft,            barTop + barHeight, 0.0D).m_6122_(0x80, 0x80, 0x80, 0xFF).m_5752_();
            worldr.m_5483_(barLeft + barWidth, barTop + barHeight, 0.0D).m_6122_(0x80, 0x80, 0x80, 0xFF).m_5752_();
            worldr.m_5483_(barLeft + barWidth, barTop,             0.0D).m_6122_(0x80, 0x80, 0x80, 0xFF).m_5752_();
            worldr.m_5483_(barLeft,            barTop,             0.0D).m_6122_(0x80, 0x80, 0x80, 0xFF).m_5752_();
            tess.m_85914_();
            worldr.m_166779_(VertexFormat.Mode.QUADS, DefaultVertexFormat.f_85815_);
            worldr.m_5483_(barLeft,                barTop + barHeight - 1, 0.0D).m_6122_(0xC0, 0xC0, 0xC0, 0xFF).m_5752_();
            worldr.m_5483_(barLeft + barWidth - 1, barTop + barHeight - 1, 0.0D).m_6122_(0xC0, 0xC0, 0xC0, 0xFF).m_5752_();
            worldr.m_5483_(barLeft + barWidth - 1, barTop,                 0.0D).m_6122_(0xC0, 0xC0, 0xC0, 0xFF).m_5752_();
            worldr.m_5483_(barLeft,                barTop,                 0.0D).m_6122_(0xC0, 0xC0, 0xC0, 0xFF).m_5752_();
            tess.m_85914_();
        }
