...
public class ModelDataManager
{
    ...
    private static void cleanCaches(Level world)
    {
        ...
        Preconditions.checkArgument(world == Minecraft.m_91087_().f_91073_, "Cannot use model data for a world other than the current client world");
    ...
    {
        Preconditions.checkArgument(world.f_46443_, "Cannot request model data for server world");
