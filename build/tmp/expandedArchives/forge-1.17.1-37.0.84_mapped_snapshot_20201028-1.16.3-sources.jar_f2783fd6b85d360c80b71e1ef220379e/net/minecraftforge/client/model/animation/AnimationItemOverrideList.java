...
*/
    ...
    public BakedModel m_173464_(BakedModel originalModel, ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity entity, int seed)
    {
        return stack.getCapability(CapabilityAnimation.ANIMATION_CAPABILITY, null)
            ...
            .map(state -> model.m_7611_(bakery, bakedTextureGetter, new CompositeModelState(state, this.state), modelLoc))
            .orElseGet(() -> super.m_173464_(originalModel, stack, world, entity, seed));
    }
}
