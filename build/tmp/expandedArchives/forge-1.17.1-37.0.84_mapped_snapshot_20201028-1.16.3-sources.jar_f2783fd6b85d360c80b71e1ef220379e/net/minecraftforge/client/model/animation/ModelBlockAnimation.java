...
public class ModelBlockAnimation
{
        ...
        protected static class MBJointClip implements IJointClip
        {
            ...
            public Transformation apply(float time)
            {
                ...
                for(MBVariableClip var : variables)
                {
                    ...
                    int s1 = Mth.m_14045_((int)Math.round(Math.floor(timeScaled)), 0, length - 1);
                    ...
                    switch(var.variable)
                    {
                        ...
                        case ANGLE:
                            ...
                            break;
                        case SCALE:
                            scale.m_122245_(value, value, value);
                            break;
                        case XS:
                            scale.setX(value);
                            break;
                ...
                Vector3f negOrigin = origin.m_122281_();
                negOrigin.m_122263_(-1,-1,-1);
                base = new Transformation(origin, null, null, null).m_121096_(base).m_121096_(new Transformation(negOrigin, null, null, null));
    ...
    public static ModelBlockAnimation loadVanillaAnimation(ResourceManager manager, ResourceLocation armatureLocation)
    {
        try
        {
            try (Resource resource = manager.m_142591_(armatureLocation))
            {
                ModelBlockAnimation mba = mbaGson.fromJson(new InputStreamReader(resource.m_6679_(), StandardCharsets.UTF_8), ModelBlockAnimation.class);
