...
public class TierSortingRegistry
{
    ...
    public static boolean isCorrectTierForDrops(Tier tier, BlockState state)
    {
        ...
        for (int x = sortedTiers.indexOf(tier) + 1; x < sortedTiers.size(); x++) {
            ...
            if (tag != null && state.m_60620_(tag))
                return false;
        }
        return true;
    }
    ...
    {
        int i = tier.m_6604_();
        if (i < 3 && state.m_60620_(BlockTags.f_144284_))
        {
            return false;
        }
        else if (i < 2 && state.m_60620_(BlockTags.f_144285_))
        {
            return false;
        }
        else if (i < 1 && state.m_60620_(BlockTags.f_144286_))
        {
            return false;
        }
        return true;
    ...
    private static class ClientEvents
    {
        ...
        {
            if (event.getNetworkManager() == null || !event.getNetworkManager().m_129531_())
                recalculateItemTiers();
        }
    }
}
