...
public class ExistingFileHelper {
    ...
    public ExistingFileHelper(Collection<Path> existingPacks, final Set<String> existingMods, boolean enable, @Nullable final String assetIndex, @Nullable final File assetsDir) {
        ...
        this.clientResources.m_10880_(new VanillaPackResources(ClientPackSource.f_174791_, "minecraft", "realms"));
        if (assetIndex != null && assetsDir != null)
        {
            this.clientResources.m_10880_(new DefaultClientPackResources(ClientPackSource.f_174791_, new AssetIndex(assetsDir, assetIndex)));
        }
        this.serverData.m_10880_(new VanillaPackResources(ServerPacksSource.f_143904_, "minecraft"));
        for (Path existing : existingPacks) {
            ...
            this.clientResources.m_10880_(pack);
            this.serverData.m_10880_(pack);
        }
