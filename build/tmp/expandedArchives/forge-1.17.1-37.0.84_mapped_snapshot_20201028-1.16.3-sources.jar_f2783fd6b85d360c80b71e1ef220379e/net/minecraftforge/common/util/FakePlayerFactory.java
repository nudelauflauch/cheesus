...
public class FakePlayerFactory
{
    ...
    {
        fakePlayers.entrySet().removeIf(entry -> entry.getValue().f_19853_ == world);
        if (MINECRAFT_PLAYER != null && MINECRAFT_PLAYER.get() != null && MINECRAFT_PLAYER.get().f_19853_ == world) // This shouldn't be strictly necessary, but lets be aggressive.
        {
            FakePlayer mc = MINECRAFT_PLAYER.get();
            if (mc != null && mc.f_19853_ == world)
            {
