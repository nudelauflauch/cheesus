...
public class ReverseTagWrapper<T>
{
    ...
    public Set<ResourceLocation> getTagNames()
    {
        ...
        if (cache == null || colCache != collection.m_5643_()) // Identity equals.
        {
            this.cache = Collections.unmodifiableSet(new HashSet<>(collection.m_13394_(target)));
            this.colCache = collection.m_5643_();
        }
        return this.cache;
    }
}
