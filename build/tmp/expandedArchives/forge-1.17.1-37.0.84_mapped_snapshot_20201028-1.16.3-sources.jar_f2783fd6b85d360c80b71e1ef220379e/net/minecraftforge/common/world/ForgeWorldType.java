...
public class ForgeWorldType extends ForgeRegistryEntry<ForgeWorldType>
{
    ...
    public interface IChunkGeneratorFactory
    {
        ...
        default WorldGenSettings createSettings(RegistryAccess dynamicRegistries, long seed, boolean generateStructures, boolean bonusChest, String generatorSettings) {
            Registry<Biome> biomeRegistry = dynamicRegistries.m_175515_(Registry.f_122885_);
            Registry<DimensionType> dimensionTypeRegistry = dynamicRegistries.m_175515_(Registry.f_122818_);
            Registry<NoiseGeneratorSettings> dimensionSettingsRegistry = dynamicRegistries.m_175515_(Registry.f_122878_);
            return new WorldGenSettings(seed, generateStructures, bonusChest,
                    WorldGenSettings.m_64633_(dimensionTypeRegistry,
                            DimensionType.m_63921_(dimensionTypeRegistry, biomeRegistry, dimensionSettingsRegistry, seed),
