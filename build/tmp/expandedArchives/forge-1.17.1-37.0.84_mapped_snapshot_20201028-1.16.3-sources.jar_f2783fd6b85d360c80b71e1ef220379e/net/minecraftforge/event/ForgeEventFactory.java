...
public class ForgeEventFactory
{
    ...
    public static boolean canEntitySpawnSpawner(Mob entity, Level world, float x, float y, float z, BaseSpawner spawner)
    {
        ...
        if (result == Result.DEFAULT)
            return entity.m_5545_(world, MobSpawnType.SPAWNER) && entity.m_6914_(world); // vanilla logic (inverted)
        else
    ...
    public static Optional<PortalShape> onTrySpawnPortal(LevelAccessor world, BlockPos pos, Optional<PortalShape> size)
    {
        ...
        return !MinecraftForge.EVENT_BUS.post(new BlockEvent.PortalSpawnEvent(world, pos, world.m_8055_(pos), size.get())) ? size : Optional.empty();
    }
    ...
    public static boolean getMobGriefingEvent(Level world, Entity entity)
    {
        ...
        return result == Result.DEFAULT ? world.m_46469_().m_46207_(GameRules.f_46132_) : result == Result.ALLOW;
    }
