...
public class ClientModLoader
{
    ...
    public static void begin(final Minecraft minecraft, final PackRepository defaultResourcePacks, final ReloadableResourceManager mcResourceManager, ClientPackSource metadataSerializer)
    {
        ...
        loading = true;
        net.minecraftforge.fmlclient.ClientModLoader.mc = minecraft;
        ...
        if (error == null) {
            ...
            mcResourceManager.m_7217_(net.minecraftforge.fmlclient.ClientModLoader::onResourceReload);
    ...
    private static void clientPackFinder(Map<IModFile, ? extends PathResourcePack> modResourcePacks, Consumer<Pack> consumer, Pack.PackConstructor factory) {
        ...
        final Pack packInfo = Pack.m_10430_("mod_resources", true, () -> new DelegatingResourcePack("mod_resources", "Mod Resources",
                new PackMetadataSection(new TranslatableComponent("fml.resources.modresources", hiddenPacks.size()), PackType.CLIENT_RESOURCES.m_143756_(SharedConstants.m_136187_())),
