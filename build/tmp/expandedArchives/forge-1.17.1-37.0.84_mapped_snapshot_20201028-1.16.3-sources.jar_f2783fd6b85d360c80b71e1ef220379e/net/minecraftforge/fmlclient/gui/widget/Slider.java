...
public class Slider extends ExtendedButton
{
    ...
    protected void m_7906_(PoseStack mStack, Minecraft par1Minecraft, int par2, int par3)
    {
        if (this.f_93624_)
        {
            ...
            GuiUtils.drawContinuousTexturedBox(mStack, f_93617_, this.f_93620_ + (int)(this.sliderValue * (float)(this.f_93618_ - 8)), this.f_93621_, 0, 66, 8, this.f_93619_, 200, 20, 2, 3, 2, 2, this.m_93252_());
        }
    }
