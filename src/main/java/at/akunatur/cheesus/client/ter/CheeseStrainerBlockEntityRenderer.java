...
public class CheeseStrainerBlockEntityRenderer implements BlockEntityRenderer<CheeseStrainerBlockEntity> {

	private Minecraft mc = Minecraft.getInstance();

	public CheeseStrainerBlockEntityRenderer(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super();
	}

	@Override
	public void render(CheeseStrainerBlockEntity te, float partialTicks, PoseStack matrixStackIn,
