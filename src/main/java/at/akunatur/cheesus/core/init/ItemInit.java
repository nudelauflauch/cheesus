...
public class ItemInit {
	...
	public static final RegistryObject<BlockItem> CHEESE_COVER = ITEMS.register("cheese_cover",
			() -> new BlockItem(BlockInit.CHEESE_COVER.get(), new Item.Properties().group(Cheesus.CHEESUS_GROUP)));

	public static final RegistryObject<BlockItem> CHEESE_STRAINER = ITEMS.register("cheese_strainer",
			() -> new BlockItem(BlockInit.CHEESE_STRAINER.get(), new Item.Properties().group(Cheesus.CHEESUS_GROUP)));

	public static final RegistryObject<BlockItem> ALPINE_CHEESE = ITEMS.register("alpine_cheese",
			() -> new BlockItem(BlockInit.ALPINE_CHEESE.get(), new Item.Properties().group(Cheesus.CHEESUS_GROUP)
	...
	public static final RegistryObject<BlockItem> CAMAEMBERT = ITEMS.register("camembert",
			() -> new BlockItem(BlockInit.CAMEMBERT.get(), new Item.Properties().group(Cheesus.CHEESUS_GROUP)
					.food(new Food.Builder().hunger(4).saturation(1.7f).build())));

	public static final RegistryObject<BlockItem> CHEDDAR = ITEMS.register("cheddar",
			() -> new BlockItem(BlockInit.CHEDDAR.get(), new Item.Properties().group(Cheesus.CHEESUS_GROUP)
					.food(new Food.Builder().hunger(4).saturation(1.7f).build())));

	public static final RegistryObject<BlockItem> DIABOLICAL_CHEESE = ITEMS.register("diabolical_cheese",
			() -> new BlockItem(BlockInit.DIABOLICAL_CHEESE.get(), new Item.Properties().group(Cheesus.CHEESUS_GROUP)
					.food(new Food.Builder().hunger(4).saturation(1.7f).build())));

	public static final RegistryObject<BlockItem> GRAUKAS = ITEMS.register("graukas",
			() -> new BlockItem(BlockInit.GRAUKAS.get(), new Item.Properties().group(Cheesus.CHEESUS_GROUP)
					.food(new Food.Builder().hunger(4).saturation(1.7f).build())));

	public static final RegistryObject<BlockItem> HERB_CHEESE = ITEMS.register(
			"herb_cheese",
			() -> new BlockItem(BlockInit.HERB_CHEESE.get(), new Item.Properties()
					.group(Cheesus.CHEESUS_GROUP)
					.food(new Food.Builder().hunger(4).saturation(1.7f).build())));
}
