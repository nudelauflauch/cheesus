...
public class CheesusRecipeProvider extends RecipeProvider implements IConditionBuilder {
    public CheesusRecipeProvider(PackOutput recipeOutput, CompletableFuture<HolderLookup.Provider> registries) {
        super(recipeOutput, registries);
    }

    @Override
    protected void buildRecipes(RecipeOutput recipeOutput) {
        cheeseRecipe(BlockInit.CHEESE.get(), ItemInit.CHEESE_SLICE.get(), recipeOutput);
        cheeseRecipe(BlockInit.ALTITUDE_CHEESE.get(), ItemInit.ALTITUDE_CHEESE_SLICE.get(), recipeOutput);
        cheeseRecipe(BlockInit.BLUE_MOLD_CHEESE.get(), ItemInit.BLUE_MOLD_CHEESE_SLICE.get(), recipeOutput);
        ...
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(BlockInit.CHEESE.get().asItem()), CuttingRecipes.KNIVES, ItemInit.CHEESE_SLICE.get(), 4)
                .build(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, "farmers_cheese_slice"));
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(BlockInit.ALTITUDE_CHEESE.get().asItem()), CuttingRecipes.KNIVES, ItemInit.ALTITUDE_CHEESE_SLICE.get(), 4)
                .build(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, "farmers_altitude_cheese_slice"));
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(BlockInit.BLUE_MOLD_CHEESE.get().asItem()), CuttingRecipes.KNIVES, ItemInit.BLUE_MOLD_CHEESE_SLICE.get(), 4)
                .build(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, "farmers_blue_mold_cheese_slice"));
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(BlockInit.DIABOLICAL_CHEESE.get().asItem()), CuttingRecipes.KNIVES, ItemInit.DIABOLICAL_CHEESE_SLICE.get(), 4)
                .build(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, "farmers_diabolical_cheese_slice"));
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(BlockInit.GREY_CHEESE.get().asItem()), CuttingRecipes.KNIVES, ItemInit.GREY_CHEESE_SLICE.get(), 4)
                .build(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, "farmers_grey_cheese_slice"));
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(BlockInit.WHITE_MOLD_CHEESE.get().asItem()), CuttingRecipes.KNIVES, ItemInit.WHITE_MOLD_CHEESE_SLICE.get(), 4)
                .build(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, "farmers_white_mold_cheese_slice"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, BlockInit.CHEESECAKE.get())
                ...
                .pattern("BEB")
                .pattern("CCC")
                .unlockedBy("has_egg", has(Items.EGG)).save(recipeOutput);
        ...
        cheeseCooking(Ingredient.of(CheesusTags.Items.CHEESE), ItemInit.BAKED_CHEESE.get(), BlockInit.CHEESE.get(), recipeOutput);
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ItemInit.SAVOURY_PASTA.get(), 1, 200, 1.0F, Items.BOWL)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, "savoury_pasta"));
    }

    private void cheeseCooking(Ingredient inputItem, ItemLike outputItem, ItemLike unlockedItem, RecipeOutput recipeOutput) {
        SimpleCookingRecipeBuilder.smelting(inputItem, RecipeCategory.FOOD, outputItem, 0.35F, 200).unlockedBy(getHasName(unlockedItem), has(unlockedItem))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, getItemName(outputItem) + "_from_smelting"));
        SimpleCookingRecipeBuilder.campfireCooking(inputItem, RecipeCategory.FOOD, outputItem, 0.35F, 600).unlockedBy(getHasName(unlockedItem), has(unlockedItem))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, getItemName(outputItem) + "_from_campfire_cooking"));
        SimpleCookingRecipeBuilder.smoking(inputItem, RecipeCategory.FOOD, outputItem, 0.35F, 100).unlockedBy(getHasName(unlockedItem), has(unlockedItem))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, getItemName(outputItem) + "_from_smoking"));
    }

    public void cheeseRecipe(ItemLike cheeseItem, ItemLike cheesePieceItem, RecipeOutput recipeOutput) {
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, cheeseItem)
                ...
                .save(recipeOutput, Cheesus.MOD_ID + ":" + getItemName(cheeseItem) + "_from_slice");
        ...
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(cheeseItem), CuttingRecipes.KNIVES, cheesePieceItem, 4)
                .build(recipeOutput, ResourceLocation.fromNamespaceAndPath(Cheesus.MOD_ID, getItemName(cheeseItem) + "_cutting_board"));
    }
}
